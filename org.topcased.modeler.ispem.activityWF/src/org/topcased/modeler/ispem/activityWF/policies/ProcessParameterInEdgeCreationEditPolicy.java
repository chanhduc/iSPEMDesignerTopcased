...
import org.topcased.modeler.ispem.activityWF.commands.ProcessParameterInEdgeCreationCommand;
import org.topcased.modeler.utils.SourceTargetData;
import org.topcased.modeler.utils.Utils;
import org.topcased.spem.ProcessParameter;

/**
 * ProcessParameterIn edge creation
 *
 * @generated
 */
public class ProcessParameterInEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new ProcessParameterInEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkCommand(Command command) {
		return command instanceof ProcessParameterInEdgeCreationCommand;
	}
