...
import org.topcased.modeler.ispem.activityWF.commands.ProcessParameterOutEdgeCreationCommand;
import org.topcased.modeler.utils.SourceTargetData;
import org.topcased.modeler.utils.Utils;
import org.topcased.spem.ProcessParameter;

/**
 * ProcessParameterOut edge creation
 *
 * @generated
 */
public class ProcessParameterOutEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new ProcessParameterOutEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkSource(GraphElement source) {
		...
		if (object instanceof org.topcased.spem.TaskUse) {
			return true;
		}
		return false;
	}
	...
	protected boolean checkTargetForSource(GraphElement source,
		...
		if (sourceObject instanceof org.topcased.spem.TaskUse
	...
	protected boolean checkCommand(Command command) {
		return command instanceof ProcessParameterOutEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source,
		...
		if (sourceObject instanceof org.topcased.spem.TaskUse
			...
			return new SourceTargetData(false, false, SourceTargetData.SOURCE,
					"org.topcased.spem.TaskUse", "ownedProcessParameter", null,
					"parameterType", "ownedProcessParameter", null, null, null);
		}
		return null;
	}
