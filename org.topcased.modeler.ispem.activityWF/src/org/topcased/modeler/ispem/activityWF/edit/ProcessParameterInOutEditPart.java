...
import org.topcased.modeler.ispem.activityWF.figures.ProcessParameterInOutFigure;
...
public class ProcessParameterInOutEditPart extends EMFGraphEdgeEditPart {
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore()
				.getString(
						ActivityWFDiagramPreferenceConstants.PROCESSPARAMETERINOUT_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore()
				.getString(
						ActivityWFDiagramPreferenceConstants.PROCESSPARAMETERINOUT_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						ActivityWFDiagramPreferenceConstants.PROCESSPARAMETERINOUT_EDGE_DEFAULT_FONT);
