...
public class JoinNodePreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return ActivityWFDiagramPreferenceConstants.JOINNODE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ActivityWFDiagramPreferenceConstants.JOINNODE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ActivityWFDiagramPreferenceConstants.JOINNODE_DEFAULT_FOREGROUND_COLOR;
	}
