...
public class ProcessParameterInPreferencePage extends
	...
	protected String getEdgeFont() {
		return ActivityWFDiagramPreferenceConstants.PROCESSPARAMETERIN_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ActivityWFDiagramPreferenceConstants.PROCESSPARAMETERIN_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ActivityWFDiagramPreferenceConstants.PROCESSPARAMETERIN_EDGE_DEFAULT_ROUTER;
	}
