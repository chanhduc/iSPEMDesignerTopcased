...
public class ProcessParameterInOutPreferencePage extends
	...
	protected String getEdgeFont() {
		return ActivityWFDiagramPreferenceConstants.PROCESSPARAMETERINOUT_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ActivityWFDiagramPreferenceConstants.PROCESSPARAMETERINOUT_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ActivityWFDiagramPreferenceConstants.PROCESSPARAMETERINOUT_EDGE_DEFAULT_ROUTER;
	}
