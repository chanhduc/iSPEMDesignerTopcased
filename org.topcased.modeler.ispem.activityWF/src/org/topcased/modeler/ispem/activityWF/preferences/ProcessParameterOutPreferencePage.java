 ...
 * @generated
 */
public class ProcessParameterOutPreferencePage extends
	...
	protected String getEdgeFont() {
		return ActivityWFDiagramPreferenceConstants.PROCESSPARAMETEROUT_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ActivityWFDiagramPreferenceConstants.PROCESSPARAMETEROUT_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ActivityWFDiagramPreferenceConstants.PROCESSPARAMETEROUT_EDGE_DEFAULT_ROUTER;
	}
	...
	protected List<String> getHiddenElements() {
		...
		if (!ps.getBoolean(ActivityWFDiagramPreferenceConstants.PROCESSPARAMETEROUT_DIRECTION_EDGE_OBJECT_DEFAULT_VISIBILITY)) {
			choiceOfValues
	...
	protected List<String> getDefaultHiddenElements() {
		List<String> choiceOfValues = new ArrayList<String>();
		IPreferenceStore ps = getPreferenceStore();
		if (!ps.getDefaultBoolean(ActivityWFDiagramPreferenceConstants.PROCESSPARAMETEROUT_DIRECTION_EDGE_OBJECT_DEFAULT_VISIBILITY)) {
			choiceOfValues
					.add(ActivityWFEdgeObjectConstants.DIRECTION_EDGE_OBJECT_ID);
		}
		return choiceOfValues;
