...
public class EdgePreferencePage extends AbstractEdgePreferencePage {
	...
	protected String getEdgeFont() {
		return ActivityWFDiagramPreferenceConstants.EDGE_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ActivityWFDiagramPreferenceConstants.EDGE_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ActivityWFDiagramPreferenceConstants.EDGE_EDGE_DEFAULT_ROUTER;
	}
