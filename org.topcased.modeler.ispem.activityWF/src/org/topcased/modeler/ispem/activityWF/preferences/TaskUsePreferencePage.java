 ...
 * @generated
 */
public class TaskUsePreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ActivityWFDiagramPreferenceConstants.TASKUSE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ActivityWFDiagramPreferenceConstants.TASKUSE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ActivityWFDiagramPreferenceConstants.TASKUSE_DEFAULT_FOREGROUND_COLOR;
	}
