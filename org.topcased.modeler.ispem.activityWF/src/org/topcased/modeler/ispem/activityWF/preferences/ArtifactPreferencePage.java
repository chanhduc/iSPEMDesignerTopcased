...
public class ArtifactPreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return ActivityWFDiagramPreferenceConstants.ARTIFACT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ActivityWFDiagramPreferenceConstants.ARTIFACT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ActivityWFDiagramPreferenceConstants.ARTIFACT_DEFAULT_FOREGROUND_COLOR;
	}
