...
public class ForkNodePreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return ActivityWFDiagramPreferenceConstants.FORKNODE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ActivityWFDiagramPreferenceConstants.FORKNODE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ActivityWFDiagramPreferenceConstants.FORKNODE_DEFAULT_FOREGROUND_COLOR;
	}
