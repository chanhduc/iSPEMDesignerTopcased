...
/**
 * A preference page to configure all preferences of the Ispem editor.
 *
 * @generated
 */
public class IspemPreferencePage extends AbstractTopcasedPreferencePage {
	/**
	 * @generated
	 */
	...
	private void createHeader(Composite parent) {
		new Label(parent, SWT.WRAP).setText("Ispem editor preference page");
	}
