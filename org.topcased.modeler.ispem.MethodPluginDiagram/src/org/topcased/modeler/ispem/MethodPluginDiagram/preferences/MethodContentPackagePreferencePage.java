 ...
 * @generated
 */
public class MethodContentPackagePreferencePage extends
	...
	protected String getNodeBackgroundColor() {
		return MethodPluginDiagramDiagramPreferenceConstants.METHODCONTENTPACKAGE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return MethodPluginDiagramDiagramPreferenceConstants.METHODCONTENTPACKAGE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return MethodPluginDiagramDiagramPreferenceConstants.METHODCONTENTPACKAGE_DEFAULT_FOREGROUND_COLOR;
	}
