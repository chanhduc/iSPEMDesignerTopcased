 ...
 * @generated
 */
public class MethodPluginPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return MethodPluginDiagramDiagramPreferenceConstants.METHODPLUGIN_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return MethodPluginDiagramDiagramPreferenceConstants.METHODPLUGIN_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return MethodPluginDiagramDiagramPreferenceConstants.METHODPLUGIN_DEFAULT_FOREGROUND_COLOR;
	}
