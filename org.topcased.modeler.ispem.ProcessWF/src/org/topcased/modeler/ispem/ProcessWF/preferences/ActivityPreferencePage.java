...
public class ActivityPreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return ProcessWFDiagramPreferenceConstants.ACTIVITY_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ProcessWFDiagramPreferenceConstants.ACTIVITY_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ProcessWFDiagramPreferenceConstants.ACTIVITY_DEFAULT_FOREGROUND_COLOR;
	}
