...
public class WorkSequencePreferencePage extends AbstractEdgePreferencePage {
	...
	protected String getEdgeFont() {
		return ProcessWFDiagramPreferenceConstants.WORKSEQUENCE_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ProcessWFDiagramPreferenceConstants.WORKSEQUENCE_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ProcessWFDiagramPreferenceConstants.WORKSEQUENCE_EDGE_DEFAULT_ROUTER;
	}
