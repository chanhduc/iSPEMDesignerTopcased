...
import org.topcased.modeler.ispem.ProcessWF.figures.WorkSequenceFigure;
...
public class WorkSequenceEditPart extends EMFGraphEdgeEditPart {
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore()
				.getString(
						ProcessWFDiagramPreferenceConstants.WORKSEQUENCE_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore()
				.getString(
						ProcessWFDiagramPreferenceConstants.WORKSEQUENCE_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						ProcessWFDiagramPreferenceConstants.WORKSEQUENCE_EDGE_DEFAULT_FONT);
