 ...
 * @generated
 */
public final class ProcessWFImageRegistry {

	/**
	 * The bundle id of the images
	 * @generated
	 */
	public static final String BUNDLE = "org.topcased.modeler.ispem.ProcessWF.images";
	 ...
	 * @generated
	 */
	private ProcessWFImageRegistry() {
		// do nothing
	}
	...
	public static Image getImage(String key) {
		return ImageRegistry.getInstance()
				.get(ProcessWFPlugin.getDefault().getBundle(),
	...
	public static ImageDescriptor getImageDescriptor(String key) {
		try {
			return ImageRegistry.getInstance().getDescriptor(
					ProcessWFPlugin.getDefault().getBundle(),
					getImageLocation(key));
