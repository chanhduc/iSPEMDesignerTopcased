...
public class RoleDefinitionPreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return TestDiagramDiagramPreferenceConstants.ROLEDEFINITION_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return TestDiagramDiagramPreferenceConstants.ROLEDEFINITION_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return TestDiagramDiagramPreferenceConstants.ROLEDEFINITION_DEFAULT_FOREGROUND_COLOR;
	}
