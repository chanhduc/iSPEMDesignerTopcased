 ...
 * @generated
 */
public class WorkSequencePreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return ProcessWFDiagramDiagramPreferenceConstants.WORKSEQUENCE_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.WORKSEQUENCE_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ProcessWFDiagramDiagramPreferenceConstants.WORKSEQUENCE_EDGE_DEFAULT_ROUTER;
	}
