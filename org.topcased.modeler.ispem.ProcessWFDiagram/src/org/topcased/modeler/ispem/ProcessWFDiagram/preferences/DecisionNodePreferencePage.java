...
public class DecisionNodePreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.DECISIONNODE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ProcessWFDiagramDiagramPreferenceConstants.DECISIONNODE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.DECISIONNODE_DEFAULT_FOREGROUND_COLOR;
	}
