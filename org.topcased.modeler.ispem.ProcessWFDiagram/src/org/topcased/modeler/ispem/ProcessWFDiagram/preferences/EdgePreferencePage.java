 ...
 * @generated
 */
public class EdgePreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return ProcessWFDiagramDiagramPreferenceConstants.EDGE_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.EDGE_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ProcessWFDiagramDiagramPreferenceConstants.EDGE_EDGE_DEFAULT_ROUTER;
	}
