 ...
 * @generated
 */
public class ForkNodePreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.FORKNODE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ProcessWFDiagramDiagramPreferenceConstants.FORKNODE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.FORKNODE_DEFAULT_FOREGROUND_COLOR;
	}
