 ...
 * @generated
 */
public class ArtifactPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.ARTIFACT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ProcessWFDiagramDiagramPreferenceConstants.ARTIFACT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.ARTIFACT_DEFAULT_FOREGROUND_COLOR;
	}
