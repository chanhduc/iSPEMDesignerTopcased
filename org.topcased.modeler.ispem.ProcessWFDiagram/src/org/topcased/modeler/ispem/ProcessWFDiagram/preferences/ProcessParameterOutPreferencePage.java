...
public class ProcessParameterOutPreferencePage extends
	...
	protected String getEdgeFont() {
		return ProcessWFDiagramDiagramPreferenceConstants.PROCESSPARAMETEROUT_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.PROCESSPARAMETEROUT_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ProcessWFDiagramDiagramPreferenceConstants.PROCESSPARAMETEROUT_EDGE_DEFAULT_ROUTER;
	}
