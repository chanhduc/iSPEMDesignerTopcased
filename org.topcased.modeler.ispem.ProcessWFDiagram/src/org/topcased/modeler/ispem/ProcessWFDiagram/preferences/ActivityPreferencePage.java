 ...
 * @generated
 */
public class ActivityPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.ACTIVITY_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ProcessWFDiagramDiagramPreferenceConstants.ACTIVITY_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.ACTIVITY_DEFAULT_FOREGROUND_COLOR;
	}
