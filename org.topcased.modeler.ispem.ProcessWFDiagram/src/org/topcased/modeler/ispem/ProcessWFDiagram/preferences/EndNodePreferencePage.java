 ...
 * @generated
 */
public class EndNodePreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.ENDNODE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ProcessWFDiagramDiagramPreferenceConstants.ENDNODE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ProcessWFDiagramDiagramPreferenceConstants.ENDNODE_DEFAULT_FOREGROUND_COLOR;
	}
