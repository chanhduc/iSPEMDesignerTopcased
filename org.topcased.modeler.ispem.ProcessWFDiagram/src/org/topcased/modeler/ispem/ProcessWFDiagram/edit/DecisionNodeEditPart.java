...
import org.topcased.modeler.ispem.ProcessWFDiagram.commands.DecisionNodeRestoreConnectionCommand;
import org.topcased.modeler.ispem.ProcessWFDiagram.figures.DecisionNodeFigure;
...
public class DecisionNodeEditPart extends NodeEditPart {
	...
	protected Color getPreferenceDefaultBackgroundColor() {
		String backgroundColor = getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.DECISIONNODE_DEFAULT_BACKGROUND_COLOR);
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String foregroundColor = getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.DECISIONNODE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.DECISIONNODE_DEFAULT_FONT);
