...
import org.topcased.modeler.ispem.ProcessWFDiagram.figures.ProcessParameterOutFigure;
...
public class ProcessParameterOutEditPart extends EMFGraphEdgeEditPart {
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.PROCESSPARAMETEROUT_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.PROCESSPARAMETEROUT_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.PROCESSPARAMETEROUT_EDGE_DEFAULT_FONT);
