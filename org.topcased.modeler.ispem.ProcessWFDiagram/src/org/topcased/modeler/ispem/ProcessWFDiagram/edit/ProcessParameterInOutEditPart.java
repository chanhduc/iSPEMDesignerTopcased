...
import org.topcased.modeler.ispem.ProcessWFDiagram.figures.ProcessParameterInOutFigure;
import org.topcased.modeler.ispem.ProcessWFDiagram.preferences.ProcessWFDiagramDiagramPreferenceConstants;
import org.topcased.modeler.utils.Utils;

/**
 * ProcessParameterInOut controller
 *
 * @generated
 */
public class ProcessParameterInOutEditPart extends EMFGraphEdgeEditPart {
	 ...
	 * @generated
	 */
	public ProcessParameterInOutEditPart(GraphEdge model) {
		super(model);
	}
	...
	protected IFigure createFigure() {
		ProcessParameterInOutFigure connection = new ProcessParameterInOutFigure();
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.PROCESSPARAMETERINOUT_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.PROCESSPARAMETERINOUT_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.PROCESSPARAMETERINOUT_EDGE_DEFAULT_FONT);
