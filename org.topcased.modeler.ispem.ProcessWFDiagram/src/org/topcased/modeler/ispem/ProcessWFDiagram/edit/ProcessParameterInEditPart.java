...
import org.topcased.modeler.ispem.ProcessWFDiagram.figures.ProcessParameterInFigure;
import org.topcased.modeler.ispem.ProcessWFDiagram.preferences.ProcessWFDiagramDiagramPreferenceConstants;
import org.topcased.modeler.utils.Utils;

/**
 * ProcessParameterIn controller
 *
 * @generated
 */
public class ProcessParameterInEditPart extends EMFGraphEdgeEditPart {
	 ...
	 * @generated
	 */
	public ProcessParameterInEditPart(GraphEdge model) {
		super(model);
	}
	...
	protected IFigure createFigure() {
		ProcessParameterInFigure connection = new ProcessParameterInFigure();
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.PROCESSPARAMETERIN_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.PROCESSPARAMETERIN_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.PROCESSPARAMETERIN_EDGE_DEFAULT_FONT);
