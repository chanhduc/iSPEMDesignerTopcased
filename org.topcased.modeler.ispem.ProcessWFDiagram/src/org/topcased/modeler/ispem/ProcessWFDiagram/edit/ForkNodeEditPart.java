...
import org.topcased.modeler.ispem.ProcessWFDiagram.commands.ForkNodeRestoreConnectionCommand;
import org.topcased.modeler.ispem.ProcessWFDiagram.figures.ForkNodeFigure;
...
public class ForkNodeEditPart extends NodeEditPart {
	...
	protected Color getPreferenceDefaultBackgroundColor() {
		String backgroundColor = getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.FORKNODE_DEFAULT_BACKGROUND_COLOR);
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String foregroundColor = getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.FORKNODE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						ProcessWFDiagramDiagramPreferenceConstants.FORKNODE_DEFAULT_FONT);
