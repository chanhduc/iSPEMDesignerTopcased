 ...
 * @generated
 */
public class RoleSetPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return RoleSetDefinitionDiagramPreferenceConstants.ROLESET_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return RoleSetDefinitionDiagramPreferenceConstants.ROLESET_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return RoleSetDefinitionDiagramPreferenceConstants.ROLESET_DEFAULT_FOREGROUND_COLOR;
	}
