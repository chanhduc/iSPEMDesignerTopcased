...
public class RoleDefinitionPreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return RoleSetDefinitionDiagramPreferenceConstants.ROLEDEFINITION_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return RoleSetDefinitionDiagramPreferenceConstants.ROLEDEFINITION_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return RoleSetDefinitionDiagramPreferenceConstants.ROLEDEFINITION_DEFAULT_FOREGROUND_COLOR;
	}
