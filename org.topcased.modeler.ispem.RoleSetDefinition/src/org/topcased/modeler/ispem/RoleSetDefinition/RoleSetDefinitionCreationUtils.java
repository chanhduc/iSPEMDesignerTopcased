 ...
 * @generated
 */
public class RoleSetDefinitionCreationUtils extends AbstractCreationUtils {
	 ...
	 * @generated
	 */
	public RoleSetDefinitionCreationUtils(DiagramGraphConf diagramConf) {
		super(diagramConf);
	}
	...
	private class GraphicUmaSwitch extends UmaSwitch {
		...
		public Object caseRoleSet(org.topcased.spem.uma.RoleSet object) {
			if ("default".equals(presentation)) {
				return createGraphElementRoleSet(object, presentation);
			}
			return null;
		}
	 ...
	 * @generated
	 */
	protected GraphElement createGraphElementRoleSet(
			org.topcased.spem.uma.RoleSet element, String presentation) {
	...
	private IPreferenceStore getPreferenceStore() {
		IEditorInput editorInput = RoleSetDefinitionPlugin.getActivePage()
		...
		if (editorInput instanceof IFileEditorInput) {
			...
			try {
				if (root.node(ProjectScope.SCOPE).node(project.getName())
						.nodeExists(RoleSetDefinitionPlugin.getId())) {
					return new ScopedPreferenceStore(new ProjectScope(project),
							RoleSetDefinitionPlugin.getId());
				}
			} catch (BackingStoreException e) {
				e.printStackTrace();
			}
		}
		return RoleSetDefinitionPlugin.getDefault().getPreferenceStore();
	}
}
