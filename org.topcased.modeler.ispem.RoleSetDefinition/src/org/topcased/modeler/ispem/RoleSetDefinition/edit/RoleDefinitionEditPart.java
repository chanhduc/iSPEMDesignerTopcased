...
import org.topcased.modeler.ispem.RoleSetDefinition.commands.RoleDefinitionRestoreConnectionCommand;
import org.topcased.modeler.ispem.RoleSetDefinition.figures.RoleDefinitionFigure;
...
public class RoleDefinitionEditPart extends EMFGraphNodeEditPart {
	...
	protected Color getPreferenceDefaultBackgroundColor() {
		String backgroundColor = getPreferenceStore()
				.getString(
						RoleSetDefinitionDiagramPreferenceConstants.ROLEDEFINITION_DEFAULT_BACKGROUND_COLOR);
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String foregroundColor = getPreferenceStore()
				.getString(
						RoleSetDefinitionDiagramPreferenceConstants.ROLEDEFINITION_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						RoleSetDefinitionDiagramPreferenceConstants.ROLEDEFINITION_DEFAULT_FONT);
