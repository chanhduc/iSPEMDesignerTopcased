...
import org.topcased.spem.uma.provider.CapabilityPatternItemProvider;

/**
 * This is the item provider adapter for a {@link org.topcased.ispem.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider
	extends CapabilityPatternItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_level_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_level_feature", "_UI_Process_type"),
				 IspemPackage.Literals.PROCESS__LEVEL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((org.topcased.ispem.Process)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(org.topcased.ispem.Process.class)) {
