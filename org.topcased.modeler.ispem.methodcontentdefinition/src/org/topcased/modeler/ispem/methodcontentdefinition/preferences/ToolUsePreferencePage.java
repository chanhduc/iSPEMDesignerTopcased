...
import org.topcased.modeler.ispem.methodcontentdefinition.MethodContentDefinitionEdgeObjectConstants;
 ...
 * @generated
 */
public class ToolUsePreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return MethodContentDefinitionDiagramPreferenceConstants.TOOLUSE_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return MethodContentDefinitionDiagramPreferenceConstants.TOOLUSE_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return MethodContentDefinitionDiagramPreferenceConstants.TOOLUSE_EDGE_DEFAULT_ROUTER;
	}
