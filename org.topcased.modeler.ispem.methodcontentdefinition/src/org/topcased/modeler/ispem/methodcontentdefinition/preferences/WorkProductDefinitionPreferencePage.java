 ...
 * @generated
 */
public class WorkProductDefinitionPreferencePage extends
	...
	protected String getNodeBackgroundColor() {
		return MethodContentDefinitionDiagramPreferenceConstants.WORKPRODUCTDEFINITION_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return MethodContentDefinitionDiagramPreferenceConstants.WORKPRODUCTDEFINITION_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return MethodContentDefinitionDiagramPreferenceConstants.WORKPRODUCTDEFINITION_DEFAULT_FOREGROUND_COLOR;
	}
