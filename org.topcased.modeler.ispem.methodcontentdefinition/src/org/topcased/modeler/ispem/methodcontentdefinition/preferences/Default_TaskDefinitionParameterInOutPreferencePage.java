 ...
 * @generated
 */
public class Default_TaskDefinitionParameterInOutPreferencePage extends
	...
	protected String getEdgeFont() {
		return MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_TASKDEFINITIONPARAMETERINOUT_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_TASKDEFINITIONPARAMETERINOUT_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_TASKDEFINITIONPARAMETERINOUT_EDGE_DEFAULT_ROUTER;
	}
