 ...
 * @generated
 */
public class RoleDefinitionPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return MethodContentDefinitionDiagramPreferenceConstants.ROLEDEFINITION_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return MethodContentDefinitionDiagramPreferenceConstants.ROLEDEFINITION_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return MethodContentDefinitionDiagramPreferenceConstants.ROLEDEFINITION_DEFAULT_FOREGROUND_COLOR;
	}
