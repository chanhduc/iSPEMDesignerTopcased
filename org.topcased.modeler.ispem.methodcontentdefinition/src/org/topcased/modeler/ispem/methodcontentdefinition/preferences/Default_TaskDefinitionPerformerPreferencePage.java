 ...
 * @generated
 */
public class Default_TaskDefinitionPerformerPreferencePage extends
	...
	protected String getEdgeFont() {
		return MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_TASKDEFINITIONPERFORMER_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_TASKDEFINITIONPERFORMER_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_TASKDEFINITIONPERFORMER_EDGE_DEFAULT_ROUTER;
	}
