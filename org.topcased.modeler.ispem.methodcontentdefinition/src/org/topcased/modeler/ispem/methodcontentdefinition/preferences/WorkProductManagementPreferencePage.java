 ...
 * @generated
 */
public class WorkProductManagementPreferencePage extends
	...
	protected String getEdgeFont() {
		return MethodContentDefinitionDiagramPreferenceConstants.WORKPRODUCTMANAGEMENT_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return MethodContentDefinitionDiagramPreferenceConstants.WORKPRODUCTMANAGEMENT_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return MethodContentDefinitionDiagramPreferenceConstants.WORKPRODUCTMANAGEMENT_EDGE_DEFAULT_ROUTER;
	}
