...
public class TaskDefinitionPreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return MethodContentDefinitionDiagramPreferenceConstants.TASKDEFINITION_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return MethodContentDefinitionDiagramPreferenceConstants.TASKDEFINITION_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return MethodContentDefinitionDiagramPreferenceConstants.TASKDEFINITION_DEFAULT_FOREGROUND_COLOR;
	}
