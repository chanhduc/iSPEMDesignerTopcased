...
import org.topcased.modeler.ispem.methodcontentdefinition.commands.Default_TaskDefinitionParameterOutEdgeCreationCommand;
import org.topcased.modeler.utils.SourceTargetData;
import org.topcased.modeler.utils.Utils;
import org.topcased.spem.Default_TaskDefinitionParameter;

/**
 * Default_TaskDefinitionParameterOut edge creation
 *
 * @generated
 */
public class Default_TaskDefinitionParameterOutEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new Default_TaskDefinitionParameterOutEdgeCreationCommand(
				domain, edge, source);
	}
	...
	protected boolean checkCommand(Command command) {
		return command instanceof Default_TaskDefinitionParameterOutEdgeCreationCommand;
	}
