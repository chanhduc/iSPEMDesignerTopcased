...
import org.topcased.modeler.ispem.methodcontentdefinition.commands.Default_TaskDefinitionParameterInOutEdgeCreationCommand;
import org.topcased.modeler.utils.SourceTargetData;
import org.topcased.modeler.utils.Utils;
import org.topcased.spem.Default_TaskDefinitionParameter;

/**
 * Default_TaskDefinitionParameterInOut edge creation
 *
 * @generated
 */
public class Default_TaskDefinitionParameterInOutEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new Default_TaskDefinitionParameterInOutEdgeCreationCommand(
				domain, edge, source);
	}
	...
	protected boolean checkCommand(Command command) {
		return command instanceof Default_TaskDefinitionParameterInOutEdgeCreationCommand;
	}
