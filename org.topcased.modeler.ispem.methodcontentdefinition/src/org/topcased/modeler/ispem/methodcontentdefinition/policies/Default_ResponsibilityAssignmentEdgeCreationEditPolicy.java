...
import org.topcased.modeler.ispem.methodcontentdefinition.commands.Default_ResponsibilityAssignmentEdgeCreationCommand;
import org.topcased.modeler.utils.SourceTargetData;
import org.topcased.modeler.utils.Utils;
import org.topcased.spem.Default_ResponsibilityAssignment;

/**
 * Default_ResponsibilityAssignment edge creation
 *
 * @generated
 */
public class Default_ResponsibilityAssignmentEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new Default_ResponsibilityAssignmentEdgeCreationCommand(domain,
				edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		return Utils.getElement(edge) instanceof Default_ResponsibilityAssignment;
	}
	...
	protected boolean checkCommand(Command command) {
		return command instanceof Default_ResponsibilityAssignmentEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source,
		...
		if (sourceObject instanceof org.topcased.spem.RoleDefinition
			...
			return new SourceTargetData(false, false, SourceTargetData.DIAGRAM,
					...
					"linkedWorkProductDefinition", null, null, null, null);
		}
		return null;
	}
