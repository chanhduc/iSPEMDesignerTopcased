...
import org.topcased.modeler.ispem.methodcontentdefinition.commands.Default_TaskDefinitionPerformerEdgeCreationCommand;
import org.topcased.modeler.utils.SourceTargetData;
import org.topcased.modeler.utils.Utils;
import org.topcased.spem.Default_TaskDefinitionPerformer;

/**
 * Default_TaskDefinitionPerformer edge creation
 *
 * @generated
 */
public class Default_TaskDefinitionPerformerEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new Default_TaskDefinitionPerformerEdgeCreationCommand(domain,
				edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		return Utils.getElement(edge) instanceof Default_TaskDefinitionPerformer;
	}
	...
	protected boolean checkSource(GraphElement source) {
		...
		if (object instanceof org.topcased.spem.RoleDefinition) {
			return true;
		}
		return false;
	}
	...
	protected boolean checkTargetForSource(GraphElement source,
		...
		if (sourceObject instanceof org.topcased.spem.RoleDefinition
				&& targetObject instanceof org.topcased.ispem.TaskDefinition) {
			return true;
		}
		return false;
	}
	...
	protected boolean checkCommand(Command command) {
		return command instanceof Default_TaskDefinitionPerformerEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source,
		...
		if (sourceObject instanceof org.topcased.spem.RoleDefinition
			...
			return new SourceTargetData(false, true, SourceTargetData.DIAGRAM,
					"org.topcased.spem.MethodContentPackage",
					"ownedMethodContentMember", "linkedRoleDefinition",
					"linkedTaskDefinition", null, null, null, null);
		}
		return null;
	}
