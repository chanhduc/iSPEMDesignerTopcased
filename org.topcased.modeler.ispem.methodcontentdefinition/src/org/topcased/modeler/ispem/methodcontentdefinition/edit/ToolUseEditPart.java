...
import org.topcased.modeler.ispem.methodcontentdefinition.figures.ToolUseFigure;
 ...
 * @generated
 */
public class ToolUseEditPart extends GraphEdgeEditPart {
	 ...
	 * @generated
	 */
	public ToolUseEditPart(GraphEdge model) {
		super(model);
	}
	...
	protected IFigure createFigure() {
		ToolUseFigure connection = new ToolUseFigure();
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore()
				.getString(
						MethodContentDefinitionDiagramPreferenceConstants.TOOLUSE_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore()
				.getString(
						MethodContentDefinitionDiagramPreferenceConstants.TOOLUSE_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						MethodContentDefinitionDiagramPreferenceConstants.TOOLUSE_EDGE_DEFAULT_FONT);
