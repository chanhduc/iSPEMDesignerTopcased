...
import org.topcased.modeler.ispem.methodcontentdefinition.figures.Default_TaskDefinitionParameterInOutFigure;
...
/**
 * Default_TaskDefinitionParameterInOut controller
 *
 * @generated
 */
public class Default_TaskDefinitionParameterInOutEditPart extends
	 ...
	 * @generated
	 */
	public Default_TaskDefinitionParameterInOutEditPart(GraphEdge model) {
		super(model);
	}
	...
	protected IFigure createFigure() {
		Default_TaskDefinitionParameterInOutFigure connection = new Default_TaskDefinitionParameterInOutFigure();
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore()
				.getString(
						MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_TASKDEFINITIONPARAMETERINOUT_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore()
				.getString(
						MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_TASKDEFINITIONPARAMETERINOUT_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_TASKDEFINITIONPARAMETERINOUT_EDGE_DEFAULT_FONT);
