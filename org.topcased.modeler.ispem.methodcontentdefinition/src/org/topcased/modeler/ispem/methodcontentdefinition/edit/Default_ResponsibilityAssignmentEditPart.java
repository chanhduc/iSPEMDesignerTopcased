...
import org.topcased.modeler.ispem.methodcontentdefinition.figures.Default_ResponsibilityAssignmentFigure;
...
/**
 * Default_ResponsibilityAssignment controller
 *
 * @generated
 */
public class Default_ResponsibilityAssignmentEditPart extends
	 ...
	 * @generated
	 */
	public Default_ResponsibilityAssignmentEditPart(GraphEdge model) {
		super(model);
	}
	...
	protected IFigure createFigure() {
		Default_ResponsibilityAssignmentFigure connection = new Default_ResponsibilityAssignmentFigure();
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore()
				.getString(
						MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_RESPONSIBILITYASSIGNMENT_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore()
				.getString(
						MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_RESPONSIBILITYASSIGNMENT_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_RESPONSIBILITYASSIGNMENT_EDGE_DEFAULT_FONT);
