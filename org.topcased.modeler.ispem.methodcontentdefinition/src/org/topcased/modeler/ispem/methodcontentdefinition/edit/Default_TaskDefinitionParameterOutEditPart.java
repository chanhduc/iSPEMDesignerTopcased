...
import org.topcased.modeler.ispem.methodcontentdefinition.figures.Default_TaskDefinitionParameterOutFigure;
...
/**
 * Default_TaskDefinitionParameterOut controller
 *
 * @generated
 */
public class Default_TaskDefinitionParameterOutEditPart extends
	 ...
	 * @generated
	 */
	public Default_TaskDefinitionParameterOutEditPart(GraphEdge model) {
		super(model);
	}
	...
	protected IFigure createFigure() {
		Default_TaskDefinitionParameterOutFigure connection = new Default_TaskDefinitionParameterOutFigure();
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore()
				.getString(
						MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_TASKDEFINITIONPARAMETEROUT_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore()
				.getString(
						MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_TASKDEFINITIONPARAMETEROUT_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						MethodContentDefinitionDiagramPreferenceConstants.DEFAULT_TASKDEFINITIONPARAMETEROUT_EDGE_DEFAULT_FONT);
