...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>uma</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class UmaExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.uma"));
				Artifact root = UmaFactory.eINSTANCE.createArtifact();
