	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SpemPackage.WORK_DEFINITION_PERFORMER: {
				...
				Object result = caseWorkDefinitionPerformer(workDefinitionPerformer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SpemPackage.WORK_DEFINITION_PARAMETER: {
				...
				Object result = caseWorkDefinitionParameter(workDefinitionParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SpemPackage.ROLE_USE: {
				...
				Object result = caseRoleUse(roleUse);
			...
			case SpemPackage.PROCESS_RESPONSIBILITY_ASSIGNMENT: {
				...
				Object result = caseProcessResponsibilityAssignment(processResponsibilityAssignment);
			...
			case SpemPackage.WORK_PRODUCT_USE: {
				...
				Object result = caseWorkProductUse(workProductUse);
			...
			case SpemPackage.WORK_PRODUCT_USE_RELATIONSHIP: {
				...
				Object result = caseWorkProductUseRelationship(workProductUseRelationship);
			...
			case SpemPackage.PROCESS_PARAMETER: {
				...
				Object result = caseProcessParameter(processParameter);
			...
			case SpemPackage.METRIC: {
				...
				Object result = caseMetric(metric);
			...
			case SpemPackage.METHOD_CONTENT_ELEMENT: {
				...
				Object result = caseMethodContentElement(methodContentElement);
			...
			case SpemPackage.ROLE_DEFINITION: {
				...
				Object result = caseRoleDefinition(roleDefinition);
			...
			case SpemPackage.WORK_PRODUCT_DEFINITION_RELATIONSHIP: {
				...
				Object result = caseWorkProductDefinitionRelationship(workProductDefinitionRelationship);
			...
			case SpemPackage.DEFAULT_TASK_DEFINITION_PERFORMER: {
				...
				Object result = caseDefault_TaskDefinitionPerformer(default_TaskDefinitionPerformer);
			...
			case SpemPackage.DEFAULT_RESPONSIBILITY_ASSIGNMENT: {
				...
				Object result = caseDefault_ResponsibilityAssignment(default_ResponsibilityAssignment);
			...
			case SpemPackage.DEFAULT_TASK_DEFINITION_PARAMETER: {
				...
				Object result = caseDefault_TaskDefinitionParameter(default_TaskDefinitionParameter);
			...
			case SpemPackage.METHOD_CONTENT_PACKAGEABLE_ELEMENT: {
				...
				Object result = caseMethodContentPackageableElement(methodContentPackageableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SpemPackage.PROCESS_PACKAGEABLE_ELEMENT: {
				...
				Object result = caseProcessPackageableElement(processPackageableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SpemPackage.METHOD_CONTENT_PACKAGE: {
				MethodContentPackage methodContentPackage = (MethodContentPackage)theEObject;
				Object result = caseMethodContentPackage(methodContentPackage);
			...
			case SpemPackage.METHOD_CONTENT_KIND: {
				...
				Object result = caseMethodContentKind(methodContentKind);
			...
			case SpemPackage.PROCESS_KIND: {
				...
				Object result = caseProcessKind(processKind);
			...
			case SpemPackage.METHOD_CONTENT_USE: {
				...
				Object result = caseMethodContentUse(methodContentUse);
			...
			case SpemPackage.TASK_USE: {
				...
				Object result = caseTaskUse(taskUse);
			...
			case SpemPackage.PROCESS_COMPONENT_USE: {
				...
				Object result = caseProcessComponentUse(processComponentUse);
			...
			case SpemPackage.METHOD_LIBRARY_PACKAGEABLE_ELEMENT: {
				...
				Object result = caseMethodLibraryPackageableElement(methodLibraryPackageableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SpemPackage.METHOD_PLUGIN_PACKAGEABLE_ELEMENT: {
				...
				Object result = caseMethodPluginPackageableElement(methodPluginPackageableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SpemPackage.WORK_PRODUCT_PORT: {
				...
				Object result = caseWorkProductPort(workProductPort);
			...
			case SpemPackage.WORK_PRODUCT_PORT_CONNECTOR: {
				...
				Object result = caseWorkProductPortConnector(workProductPortConnector);
