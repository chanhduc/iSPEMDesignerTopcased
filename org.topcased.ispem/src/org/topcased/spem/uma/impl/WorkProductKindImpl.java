...
import org.topcased.spem.impl.KindImpl;
 ...
 * <ul>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getPresentationName <em>Presentation Name</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getBriefDescription <em>Brief Description</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getMainDescription <em>Main Description</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getGuidance <em>Guidance</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getMetric <em>Metric</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getChangeDate <em>Change Date</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getChangeDescription <em>Change Description</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getVariabilityType <em>Variability Type</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getVariabilityBasedOnElement <em>Variability Based On Element</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.WorkProductKindImpl#getMethodContentKind <em>Method Content Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WorkProductKindImpl extends KindImpl implements WorkProductKind {
	...
	public EList getGuidance() {
		if (guidance == null) {
			guidance = new EObjectResolvingEList(Guidance.class, this, UmaPackage.WORK_PRODUCT_KIND__GUIDANCE);
		}
		return guidance;
	}
	...
	public EList getMetric() {
		if (metric == null) {
			metric = new EObjectResolvingEList(Metric.class, this, UmaPackage.WORK_PRODUCT_KIND__METRIC);
		}
		return metric;
	}
	...
	public EList getCategory() {
		if (category == null) {
			category = new EObjectWithInverseResolvingEList.ManyInverse(Category.class, this, UmaPackage.WORK_PRODUCT_KIND__CATEGORY, SpemPackage.CATEGORY__CATEGORIZED_ELEMENT);
		}
		return category;
	}
	...
	public EList getAuthor() {
		if (author == null) {
			author = new EDataTypeUniqueEList(String.class, this, UmaPackage.WORK_PRODUCT_KIND__AUTHOR);
		}
		return author;
	}
