...
import org.topcased.spem.impl.GuidanceImpl;
 ...
 * <ul>
 *   <li>{@link org.topcased.spem.uma.impl.PracticeImpl#getSubPractice <em>Sub Practice</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.PracticeImpl#getReferencedActivity <em>Referenced Activity</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.PracticeImpl#getContentReference <em>Content Reference</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.PracticeImpl#getAdditionalInfo <em>Additional Info</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.PracticeImpl#getApplication <em>Application</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.PracticeImpl#getBackground <em>Background</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.PracticeImpl#getGoal <em>Goal</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.PracticeImpl#getLevelOfAdoption <em>Level Of Adoption</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.PracticeImpl#getProblem <em>Problem</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PracticeImpl extends GuidanceImpl implements Practice {
	 ...
	 * @ordered
	 */
	protected EList referencedActivity;
	 ...
	 * @ordered
	 */
	protected EList contentReference;
	 ...
	 * @ordered
	 */
	protected EList levelOfAdoption;
	...
	public EList getSubPractice() {
		if (subPractice == null) {
			subPractice = new EObjectContainmentEList(Practice.class, this, UmaPackage.PRACTICE__SUB_PRACTICE);
		}
		return subPractice;
	}
	 ...
	 * @generated
	 */
	public EList getReferencedActivity() {
		if (referencedActivity == null) {
			referencedActivity = new EObjectResolvingEList(Activity.class, this, UmaPackage.PRACTICE__REFERENCED_ACTIVITY);
		}
	...
	public EList getContentReference() {
		if (contentReference == null) {
			contentReference = new EObjectResolvingEList(MethodContentElement.class, this, UmaPackage.PRACTICE__CONTENT_REFERENCE);
		}
	...
	public EList getGoal() {
		if (goal == null) {
			goal = new EDataTypeUniqueEList(String.class, this, UmaPackage.PRACTICE__GOAL);
		}
		return goal;
	}
	...
	public EList getLevelOfAdoption() {
		if (levelOfAdoption == null) {
			levelOfAdoption = new EDataTypeUniqueEList(String.class, this, UmaPackage.PRACTICE__LEVEL_OF_ADOPTION);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UmaPackage.PRACTICE__REFERENCED_ACTIVITY:
				...
				getReferencedActivity().addAll((Collection)newValue);
				return;
			case UmaPackage.PRACTICE__CONTENT_REFERENCE:
			...
			case UmaPackage.PRACTICE__LEVEL_OF_ADOPTION:
				...
				getLevelOfAdoption().addAll((Collection)newValue);
				return;
			case UmaPackage.PRACTICE__PROBLEM:
