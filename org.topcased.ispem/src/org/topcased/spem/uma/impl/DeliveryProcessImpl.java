 ...
 * <ul>
 *   <li>{@link org.topcased.spem.uma.impl.DeliveryProcessImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.DeliveryProcessImpl#getProjectCharacteristics <em>Project Characteristics</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.DeliveryProcessImpl#getRiskLevel <em>Risk Level</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.DeliveryProcessImpl#getEstimatingTechnique <em>Estimating Technique</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.DeliveryProcessImpl#getProjectMemberExpertise <em>Project Member Expertise</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.DeliveryProcessImpl#getTypeOfContract <em>Type Of Contract</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.DeliveryProcessImpl#getCommunicationMaterial <em>Communication Material</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.DeliveryProcessImpl#getEducationalMaterial <em>Educational Material</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeliveryProcessImpl extends ProcessImpl implements DeliveryProcess {
	 ...
	 * @ordered
	 */
	protected static final RiskLevel RISK_LEVEL_EDEFAULT = RiskLevel.LOW_LITERAL;
	 ...
	 * @ordered
	 */
	protected static final EstimatingTechnique ESTIMATING_TECHNIQUE_EDEFAULT = EstimatingTechnique.COST_LITERAL;
	 ...
	 * @ordered
	 */
	protected static final ExpertiseLevel PROJECT_MEMBER_EXPERTISE_EDEFAULT = ExpertiseLevel.LOW_LITERAL;
	 ...
	 * @ordered
	 */
	protected static final ContractKind TYPE_OF_CONTRACT_EDEFAULT = ContractKind.EXPRESS_LITERAL;
	 ...
	 * @ordered
	 */
	protected EList communicationMaterial;
	 ...
	 * @ordered
	 */
	protected EList educationalMaterial;
	 ...
	 * @generated
	 */
	public EList getCommunicationMaterial() {
		if (communicationMaterial == null) {
			communicationMaterial = new EObjectResolvingEList(SupportingMaterial.class, this, UmaPackage.DELIVERY_PROCESS__COMMUNICATION_MATERIAL);
		}
	 ...
	 * @generated
	 */
	public EList getEducationalMaterial() {
		if (educationalMaterial == null) {
			educationalMaterial = new EObjectResolvingEList(SupportingMaterial.class, this, UmaPackage.DELIVERY_PROCESS__EDUCATIONAL_MATERIAL);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UmaPackage.DELIVERY_PROCESS__COMMUNICATION_MATERIAL:
				...
				getCommunicationMaterial().addAll((Collection)newValue);
				return;
			case UmaPackage.DELIVERY_PROCESS__EDUCATIONAL_MATERIAL:
				getEducationalMaterial().clear();
				getEducationalMaterial().addAll((Collection)newValue);
				return;
		}
