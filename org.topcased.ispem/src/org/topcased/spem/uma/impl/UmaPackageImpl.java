...
import org.topcased.ispem.impl.IspemPackageImpl;
...
public class UmaPackageImpl extends EPackageImpl implements UmaPackage {
	 ...
	 * @see org.topcased.spem.uma.UmaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static UmaPackage init() {
		...
		IspemPackageImpl theIspemPackage = (IspemPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(IspemPackage.eNS_URI) instanceof IspemPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(IspemPackage.eNS_URI) : IspemPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEClass(processEClass, org.topcased.spem.uma.Process.class, "Process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProcess_IncludedPattern(), this.getCapabilityPattern(), null, "includedPattern", null, 0, -1, org.topcased.spem.uma.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcess_Scope(), ecorePackage.getEString(), "scope", null, 0, 1, org.topcased.spem.uma.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcess_UsageNote(), ecorePackage.getEString(), "usageNote", null, 0, -1, org.topcased.spem.uma.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcess_IncludedConnector(), theSpemPackage.getWorkProductPortConnector(), null, "includedConnector", null, 0, -1, org.topcased.spem.uma.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(riskLevelEEnum, RiskLevel.LOW_LITERAL);
		addEEnumLiteral(riskLevelEEnum, RiskLevel.MID_LITERAL);
		addEEnumLiteral(riskLevelEEnum, RiskLevel.HIGH_LITERAL);

		initEEnum(estimatingTechniqueEEnum, EstimatingTechnique.class, "EstimatingTechnique");
		addEEnumLiteral(estimatingTechniqueEEnum, EstimatingTechnique.COST_LITERAL);
		addEEnumLiteral(estimatingTechniqueEEnum, EstimatingTechnique.TIME_LITERAL);
		addEEnumLiteral(estimatingTechniqueEEnum, EstimatingTechnique.SKILLS_LITERAL);
		addEEnumLiteral(estimatingTechniqueEEnum, EstimatingTechnique.DEFECTS_LITERAL);
		addEEnumLiteral(estimatingTechniqueEEnum, EstimatingTechnique.OTHER_LITERAL);

		initEEnum(expertiseLevelEEnum, ExpertiseLevel.class, "ExpertiseLevel");
		addEEnumLiteral(expertiseLevelEEnum, ExpertiseLevel.LOW_LITERAL);
		addEEnumLiteral(expertiseLevelEEnum, ExpertiseLevel.MID_LITERAL);
		addEEnumLiteral(expertiseLevelEEnum, ExpertiseLevel.LEVEL_LITERAL);

		initEEnum(contractKindEEnum, ContractKind.class, "ContractKind");
		addEEnumLiteral(contractKindEEnum, ContractKind.EXPRESS_LITERAL);
		addEEnumLiteral(contractKindEEnum, ContractKind.IMPLIED_LITERAL);
		addEEnumLiteral(contractKindEEnum, ContractKind.OTHER_LITERAL);
