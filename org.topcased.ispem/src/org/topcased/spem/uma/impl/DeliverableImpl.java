 ...
 * <ul>
 *   <li>{@link org.topcased.spem.uma.impl.DeliverableImpl#getDeliveredProduct <em>Delivered Product</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.DeliverableImpl#getExternalDescription <em>External Description</em>}</li>
 *   <li>{@link org.topcased.spem.uma.impl.DeliverableImpl#getPackagingGuidance <em>Packaging Guidance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeliverableImpl extends WorkProductUseImpl implements Deliverable {
	 ...
	 * @ordered
	 */
	protected EList deliveredProduct;
	 ...
	 * @generated
	 */
	public EList getDeliveredProduct() {
		if (deliveredProduct == null) {
			deliveredProduct = new EObjectResolvingEList(WorkProductUse.class, this, UmaPackage.DELIVERABLE__DELIVERED_PRODUCT);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case UmaPackage.DELIVERABLE__DELIVERED_PRODUCT:
				...
				getDeliveredProduct().addAll((Collection)newValue);
				return;
			case UmaPackage.DELIVERABLE__EXTERNAL_DESCRIPTION:
