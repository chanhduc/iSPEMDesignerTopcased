 ...
 * <ul>
 *   <li>{@link org.topcased.spem.uma.impl.DomainImpl#getRelatedProduct <em>Related Product</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DomainImpl extends CategoryImpl implements Domain {
	 ...
	 * @ordered
	 */
	protected EList relatedProduct;
	 ...
	 * @generated
	 */
	public EList getRelatedProduct() {
		if (relatedProduct == null) {
			relatedProduct = new EObjectResolvingEList(WorkProductDefinition.class, this, UmaPackage.DOMAIN__RELATED_PRODUCT);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case UmaPackage.DOMAIN__RELATED_PRODUCT:
				...
				getRelatedProduct().addAll((Collection)newValue);
				return;
		}
