 ...
 * <ul>
 *   <li>{@link org.topcased.spem.impl.WorkBreakdownElementImpl#isIsRepeatable <em>Is Repeatable</em>}</li>
 *   <li>{@link org.topcased.spem.impl.WorkBreakdownElementImpl#isIsOngoing <em>Is Ongoing</em>}</li>
 *   <li>{@link org.topcased.spem.impl.WorkBreakdownElementImpl#isIsEventDriven <em>Is Event Driven</em>}</li>
 *   <li>{@link org.topcased.spem.impl.WorkBreakdownElementImpl#getLinkToPredecessor <em>Link To Predecessor</em>}</li>
 *   <li>{@link org.topcased.spem.impl.WorkBreakdownElementImpl#getLinkToSuccessor <em>Link To Successor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class WorkBreakdownElementImpl extends BreakdownElementImpl implements WorkBreakdownElement {
	...
	public EList getLinkToPredecessor() {
		if (linkToPredecessor == null) {
			linkToPredecessor = new EObjectWithInverseResolvingEList(WorkSequence.class, this, SpemPackage.WORK_BREAKDOWN_ELEMENT__LINK_TO_PREDECESSOR, SpemPackage.WORK_SEQUENCE__SUCCESSOR);
		}
	...
	public EList getLinkToSuccessor() {
		if (linkToSuccessor == null) {
			linkToSuccessor = new EObjectWithInverseResolvingEList(WorkSequence.class, this, SpemPackage.WORK_BREAKDOWN_ELEMENT__LINK_TO_SUCCESSOR, SpemPackage.WORK_SEQUENCE__PREDECESSOR);
		}
