 ...
 * <ul>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getPresentationName <em>Presentation Name</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getBriefDescription <em>Brief Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getMainDescription <em>Main Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getGuidance <em>Guidance</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getMetric <em>Metric</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getChangeDate <em>Change Date</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getChangeDescription <em>Change Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getVariabilityType <em>Variability Type</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getVariabilityBasedOnElement <em>Variability Based On Element</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getPredecessor <em>Predecessor</em>}</li>
 *   <li>{@link org.topcased.spem.impl.StepImpl#getSuccessor <em>Successor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StepImpl extends WorkDefinitionImpl implements Step {
	...
	public EList getGuidance() {
		if (guidance == null) {
			guidance = new EObjectResolvingEList(Guidance.class, this, SpemPackage.STEP__GUIDANCE);
		}
		return guidance;
	}
	...
	public EList getMetric() {
		if (metric == null) {
			metric = new EObjectResolvingEList(Metric.class, this, SpemPackage.STEP__METRIC);
		}
		return metric;
	}
	...
	public EList getCategory() {
		if (category == null) {
			category = new EObjectWithInverseResolvingEList.ManyInverse(Category.class, this, SpemPackage.STEP__CATEGORY, SpemPackage.CATEGORY__CATEGORIZED_ELEMENT);
		}
		return category;
	}
	...
	public EList getAuthor() {
		if (author == null) {
			author = new EDataTypeUniqueEList(String.class, this, SpemPackage.STEP__AUTHOR);
		}
		return author;
	}
