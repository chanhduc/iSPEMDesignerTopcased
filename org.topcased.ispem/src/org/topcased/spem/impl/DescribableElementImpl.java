 ...
 * <ul>
 *   <li>{@link org.topcased.spem.impl.DescribableElementImpl#getPresentationName <em>Presentation Name</em>}</li>
 *   <li>{@link org.topcased.spem.impl.DescribableElementImpl#getBriefDescription <em>Brief Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.DescribableElementImpl#getMainDescription <em>Main Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.DescribableElementImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link org.topcased.spem.impl.DescribableElementImpl#getGuidance <em>Guidance</em>}</li>
 *   <li>{@link org.topcased.spem.impl.DescribableElementImpl#getMetric <em>Metric</em>}</li>
 *   <li>{@link org.topcased.spem.impl.DescribableElementImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.topcased.spem.impl.DescribableElementImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link org.topcased.spem.impl.DescribableElementImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.topcased.spem.impl.DescribableElementImpl#getChangeDate <em>Change Date</em>}</li>
 *   <li>{@link org.topcased.spem.impl.DescribableElementImpl#getChangeDescription <em>Change Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.DescribableElementImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DescribableElementImpl extends ExtensibleElementImpl implements DescribableElement {
	...
	public EList getGuidance() {
		if (guidance == null) {
			guidance = new EObjectResolvingEList(Guidance.class, this, SpemPackage.DESCRIBABLE_ELEMENT__GUIDANCE);
		}
		return guidance;
	}
	...
	public EList getMetric() {
		if (metric == null) {
			metric = new EObjectResolvingEList(Metric.class, this, SpemPackage.DESCRIBABLE_ELEMENT__METRIC);
		}
		return metric;
	}
	...
	public EList getCategory() {
		if (category == null) {
			category = new EObjectWithInverseResolvingEList.ManyInverse(Category.class, this, SpemPackage.DESCRIBABLE_ELEMENT__CATEGORY, SpemPackage.CATEGORY__CATEGORIZED_ELEMENT);
		}
		return category;
	}
	...
	public EList getAuthor() {
		if (author == null) {
			author = new EDataTypeUniqueEList(String.class, this, SpemPackage.DESCRIBABLE_ELEMENT__AUTHOR);
		}
		return author;
	}
