...
import org.topcased.spem.MethodLibraryPackageableElement;
...
import org.topcased.spem.WorkDefinitionPerformer;
...
public class SpemPackageImpl extends EPackageImpl implements SpemPackage {
	 ...
	 * @see org.topcased.spem.SpemPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		addEEnumLiteral(workSequenceKindEEnum, WorkSequenceKind.FINISH_TO_START_LITERAL);
		addEEnumLiteral(workSequenceKindEEnum, WorkSequenceKind.FINISH_TO_FINISH_LITERAL);
		addEEnumLiteral(workSequenceKindEEnum, WorkSequenceKind.START_TO_START_LITERAL);
		addEEnumLiteral(workSequenceKindEEnum, WorkSequenceKind.START_TO_FINISH_LITERAL);

		initEEnum(activityUseKindEEnum, ActivityUseKind.class, "ActivityUseKind");
		addEEnumLiteral(activityUseKindEEnum, ActivityUseKind.NA_LITERAL);
		addEEnumLiteral(activityUseKindEEnum, ActivityUseKind.EXTENSION_LITERAL);
		addEEnumLiteral(activityUseKindEEnum, ActivityUseKind.LOCAL_CONTRIBUTION_LITERAL);
		addEEnumLiteral(activityUseKindEEnum, ActivityUseKind.LOCAL_REPLACEMENT_LITERAL);

		initEEnum(optionalityKindEEnum, OptionalityKind.class, "OptionalityKind");
		addEEnumLiteral(optionalityKindEEnum, OptionalityKind.MANDATORY_LITERAL);
		addEEnumLiteral(optionalityKindEEnum, OptionalityKind.OPTIONAL_LITERAL);
		...
		addEEnumLiteral(workProductRelationshipKindEEnum, WorkProductRelationshipKind.IMPACTED_BY_LITERAL);
		addEEnumLiteral(workProductRelationshipKindEEnum, WorkProductRelationshipKind.COMPOSITION_LITERAL);
		addEEnumLiteral(workProductRelationshipKindEEnum, WorkProductRelationshipKind.AGGREGATION_LITERAL);
