 ...
 * <ul>
 *   <li>{@link org.topcased.spem.impl.Default_ResponsibilityAssignmentImpl#getLinkedRoleDefinition <em>Linked Role Definition</em>}</li>
 *   <li>{@link org.topcased.spem.impl.Default_ResponsibilityAssignmentImpl#getLinkedWorkProductDefinition <em>Linked Work Product Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Default_ResponsibilityAssignmentImpl extends MethodContentElementImpl implements Default_ResponsibilityAssignment {
	...
	public EList getLinkedRoleDefinition() {
		if (linkedRoleDefinition == null) {
			linkedRoleDefinition = new EObjectResolvingEList(RoleDefinition.class, this, SpemPackage.DEFAULT_RESPONSIBILITY_ASSIGNMENT__LINKED_ROLE_DEFINITION);
		}
