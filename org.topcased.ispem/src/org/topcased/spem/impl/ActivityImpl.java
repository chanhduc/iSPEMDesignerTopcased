 ...
 * <ul>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getPresentationName <em>Presentation Name</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getBriefDescription <em>Brief Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getMainDescription <em>Main Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getGuidance <em>Guidance</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getMetric <em>Metric</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getChangeDate <em>Change Date</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getChangeDescription <em>Change Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getProcessKind <em>Process Kind</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#isHasMultipleOccurrences <em>Has Multiple Occurrences</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#isIsOptional <em>Is Optional</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#isIsPlanned <em>Is Planned</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getPlanningData <em>Planning Data</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#isIsRepeatable <em>Is Repeatable</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#isIsOngoing <em>Is Ongoing</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#isIsEventDriven <em>Is Event Driven</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getLinkToPredecessor <em>Link To Predecessor</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getLinkToSuccessor <em>Link To Successor</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getVariabilityType <em>Variability Type</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getVariabilityBasedOnElement <em>Variability Based On Element</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getUseKind <em>Use Kind</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getUsedActivity <em>Used Activity</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getNestedBreakdownElement <em>Nested Breakdown Element</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getSuppressedBreakdownElement <em>Suppressed Breakdown Element</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getOwnedProcessParameter <em>Owned Process Parameter</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getDefaultContext <em>Default Context</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#getValidContext <em>Valid Context</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ActivityImpl#isIsEnactable <em>Is Enactable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivityImpl extends WorkDefinitionImpl implements Activity {
	 ...
	 * @ordered
	 */
	protected static final ActivityUseKind USE_KIND_EDEFAULT = ActivityUseKind.NA_LITERAL;
	 ...
	 * @ordered
	 */
	protected EList nestedBreakdownElement;
	 ...
	 * @ordered
	 */
	protected EList suppressedBreakdownElement;
	...
	public EList getGuidance() {
		if (guidance == null) {
			guidance = new EObjectResolvingEList(Guidance.class, this, SpemPackage.ACTIVITY__GUIDANCE);
		}
		return guidance;
	}
	...
	public EList getMetric() {
		if (metric == null) {
			metric = new EObjectResolvingEList(Metric.class, this, SpemPackage.ACTIVITY__METRIC);
		}
		return metric;
	}
	...
	public EList getCategory() {
		if (category == null) {
			category = new EObjectWithInverseResolvingEList.ManyInverse(Category.class, this, SpemPackage.ACTIVITY__CATEGORY, SpemPackage.CATEGORY__CATEGORIZED_ELEMENT);
		}
		return category;
	}
	...
	public EList getAuthor() {
		if (author == null) {
			author = new EDataTypeUniqueEList(String.class, this, SpemPackage.ACTIVITY__AUTHOR);
		}
		return author;
	}
	...
	public EList getLinkToPredecessor() {
		if (linkToPredecessor == null) {
			linkToPredecessor = new EObjectWithInverseResolvingEList(WorkSequence.class, this, SpemPackage.ACTIVITY__LINK_TO_PREDECESSOR, SpemPackage.WORK_SEQUENCE__SUCCESSOR);
		}
	...
	public EList getLinkToSuccessor() {
		if (linkToSuccessor == null) {
			linkToSuccessor = new EObjectWithInverseResolvingEList(WorkSequence.class, this, SpemPackage.ACTIVITY__LINK_TO_SUCCESSOR, SpemPackage.WORK_SEQUENCE__PREDECESSOR);
		}
	 ...
	 * @generated
	 */
	public EList getNestedBreakdownElement() {
		if (nestedBreakdownElement == null) {
			nestedBreakdownElement = new EObjectContainmentEList(BreakdownElement.class, this, SpemPackage.ACTIVITY__NESTED_BREAKDOWN_ELEMENT);
		}
	 ...
	 * @generated
	 */
	public EList getSuppressedBreakdownElement() {
		if (suppressedBreakdownElement == null) {
			suppressedBreakdownElement = new EObjectResolvingEList(BreakdownElement.class, this, SpemPackage.ACTIVITY__SUPPRESSED_BREAKDOWN_ELEMENT);
		}
	...
	public EList getOwnedProcessParameter() {
		if (ownedProcessParameter == null) {
			ownedProcessParameter = new EObjectContainmentEList(ProcessParameter.class, this, SpemPackage.ACTIVITY__OWNED_PROCESS_PARAMETER);
		}
	...
	public EList getValidContext() {
		if (validContext == null) {
			validContext = new EObjectResolvingEList(MethodConfiguration.class, this, SpemPackage.ACTIVITY__VALID_CONTEXT);
		}
		return validContext;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SpemPackage.ACTIVITY__NESTED_BREAKDOWN_ELEMENT:
				...
				getNestedBreakdownElement().addAll((Collection)newValue);
				return;
			case SpemPackage.ACTIVITY__SUPPRESSED_BREAKDOWN_ELEMENT:
				getSuppressedBreakdownElement().clear();
				getSuppressedBreakdownElement().addAll((Collection)newValue);
				return;
			case SpemPackage.ACTIVITY__OWNED_PROCESS_PARAMETER:
