 ...
 * <ul>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getPresentationName <em>Presentation Name</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getBriefDescription <em>Brief Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getMainDescription <em>Main Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getGuidance <em>Guidance</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getMetric <em>Metric</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getChangeDate <em>Change Date</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getChangeDescription <em>Change Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getVariabilityType <em>Variability Type</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getVariabilityBasedOnElement <em>Variability Based On Element</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getMethodContentKind <em>Method Content Kind</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getOwnedTaskDefinitionParameter <em>Owned Task Definition Parameter</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getStep <em>Step</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getRequiredQualification <em>Required Qualification</em>}</li>
 *   <li>{@link org.topcased.spem.impl.TaskDefinitionImpl#getUsedTool <em>Used Tool</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaskDefinitionImpl extends WorkDefinitionImpl implements TaskDefinition {
	...
	public EList getGuidance() {
		if (guidance == null) {
			guidance = new EObjectResolvingEList(Guidance.class, this, SpemPackage.TASK_DEFINITION__GUIDANCE);
		}
		return guidance;
	}
	...
	public EList getMetric() {
		if (metric == null) {
			metric = new EObjectResolvingEList(Metric.class, this, SpemPackage.TASK_DEFINITION__METRIC);
		}
		return metric;
	}
	...
	public EList getCategory() {
		if (category == null) {
			category = new EObjectWithInverseResolvingEList.ManyInverse(Category.class, this, SpemPackage.TASK_DEFINITION__CATEGORY, SpemPackage.CATEGORY__CATEGORIZED_ELEMENT);
		}
		return category;
	}
	...
	public EList getAuthor() {
		if (author == null) {
			author = new EDataTypeUniqueEList(String.class, this, SpemPackage.TASK_DEFINITION__AUTHOR);
		}
		return author;
	}
	...
	public EList getOwnedTaskDefinitionParameter() {
		if (ownedTaskDefinitionParameter == null) {
			ownedTaskDefinitionParameter = new EObjectContainmentEList(Default_TaskDefinitionParameter.class, this, SpemPackage.TASK_DEFINITION__OWNED_TASK_DEFINITION_PARAMETER);
		}
	...
	public EList getUsedTool() {
		if (usedTool == null) {
			usedTool = new EObjectResolvingEList(ToolDefinition.class, this, SpemPackage.TASK_DEFINITION__USED_TOOL);
		}
		return usedTool;
	}
	...
	public EList getStep() {
		if (step == null) {
			step = new EObjectContainmentEList(Step.class, this, SpemPackage.TASK_DEFINITION__STEP);
		}
		return step;
	}
	...
	public EList getRequiredQualification() {
		if (requiredQualification == null) {
			requiredQualification = new EObjectResolvingEList(Qualification.class, this, SpemPackage.TASK_DEFINITION__REQUIRED_QUALIFICATION);
		}
