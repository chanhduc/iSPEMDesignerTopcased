 ...
 * <ul>
 *   <li>{@link org.topcased.spem.impl.MethodLibraryImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.topcased.spem.impl.MethodLibraryImpl#getOwnedMethodPlugin <em>Owned Method Plugin</em>}</li>
 *   <li>{@link org.topcased.spem.impl.MethodLibraryImpl#getPredefinedConfiguration <em>Predefined Configuration</em>}</li>
 *   <li>{@link org.topcased.spem.impl.MethodLibraryImpl#getConfigurationPackage <em>Configuration Package</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MethodLibraryImpl extends EObjectImpl implements MethodLibrary {
	 ...
	 * @ordered
	 */
	protected EList ownedMethodPlugin;
	 ...
	 * @ordered
	 */
	protected EList predefinedConfiguration;
	 ...
	 * @generated
	 */
	public EList getOwnedMethodPlugin() {
		if (ownedMethodPlugin == null) {
			ownedMethodPlugin = new EObjectContainmentEList(MethodPlugin.class, this, SpemPackage.METHOD_LIBRARY__OWNED_METHOD_PLUGIN);
		}
	 ...
	 * @generated
	 */
	public EList getPredefinedConfiguration() {
		if (predefinedConfiguration == null) {
			predefinedConfiguration = new EObjectContainmentEList(MethodConfiguration.class, this, SpemPackage.METHOD_LIBRARY__PREDEFINED_CONFIGURATION);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SpemPackage.METHOD_LIBRARY__OWNED_METHOD_PLUGIN:
				...
				getOwnedMethodPlugin().addAll((Collection)newValue);
				return;
			case SpemPackage.METHOD_LIBRARY__PREDEFINED_CONFIGURATION:
				getPredefinedConfiguration().clear();
				getPredefinedConfiguration().addAll((Collection)newValue);
				return;
			case SpemPackage.METHOD_LIBRARY__CONFIGURATION_PACKAGE:
