 ...
 * <ul>
 *   <li>{@link org.topcased.spem.impl.ProcessComponentImpl#getProcess <em>Process</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessComponentImpl#getOwnedPort <em>Owned Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessComponentImpl extends ProcessPackageImpl implements ProcessComponent {
	 ...
	 * @generated
	 */
	public EList getOwnedPort() {
		if (ownedPort == null) {
			ownedPort = new EObjectContainmentEList(WorkProductPort.class, this, SpemPackage.PROCESS_COMPONENT__OWNED_PORT);
		}
		return ownedPort;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SpemPackage.PROCESS_COMPONENT__OWNED_PORT:
				getOwnedPort().clear();
				getOwnedPort().addAll((Collection)newValue);
				return;
		}
