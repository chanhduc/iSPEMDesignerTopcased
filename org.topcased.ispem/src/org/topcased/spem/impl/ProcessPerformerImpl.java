 ...
 * <ul>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getPresentationName <em>Presentation Name</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getBriefDescription <em>Brief Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getMainDescription <em>Main Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getGuidance <em>Guidance</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getMetric <em>Metric</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getChangeDate <em>Change Date</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getChangeDescription <em>Change Description</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getProcessKind <em>Process Kind</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#isHasMultipleOccurrences <em>Has Multiple Occurrences</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#isIsOptional <em>Is Optional</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#isIsPlanned <em>Is Planned</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getPlanningData <em>Planning Data</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getLinkedRoleUse <em>Linked Role Use</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getLinkedActivity <em>Linked Activity</em>}</li>
 *   <li>{@link org.topcased.spem.impl.ProcessPerformerImpl#getLinkedTaskUse <em>Linked Task Use</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessPerformerImpl extends WorkDefinitionPerformerImpl implements ProcessPerformer {
	...
	public EList getGuidance() {
		if (guidance == null) {
			guidance = new EObjectResolvingEList(Guidance.class, this, SpemPackage.PROCESS_PERFORMER__GUIDANCE);
		}
		return guidance;
	}
	...
	public EList getMetric() {
		if (metric == null) {
			metric = new EObjectResolvingEList(Metric.class, this, SpemPackage.PROCESS_PERFORMER__METRIC);
		}
		return metric;
	}
	...
	public EList getCategory() {
		if (category == null) {
			category = new EObjectWithInverseResolvingEList.ManyInverse(Category.class, this, SpemPackage.PROCESS_PERFORMER__CATEGORY, SpemPackage.CATEGORY__CATEGORIZED_ELEMENT);
		}
		return category;
	}
	...
	public EList getAuthor() {
		if (author == null) {
			author = new EDataTypeUniqueEList(String.class, this, SpemPackage.PROCESS_PERFORMER__AUTHOR);
		}
		return author;
	}
	...
	public EList getLinkedRoleUse() {
		if (linkedRoleUse == null) {
			linkedRoleUse = new EObjectResolvingEList(RoleUse.class, this, SpemPackage.PROCESS_PERFORMER__LINKED_ROLE_USE);
		}
