 ...
 ******************************************************************************/
package org.topcased.modeler.family;
 ...
 * @generated
 */
public final class FamilyImageRegistry {

	/**
	 * The bundle id of the image
	 * @generated
	 */
	public static final String BUNDLE = "org.topcased.modeler.family.images";
	...
	public static Image getImage(String key) {
		return ImageRegistry.getInstance().get(
				FamilyPlugin.getDefault().getBundle(), getImageLocation(key));
	}
	...
	public static ImageDescriptor getImageDescriptor(String key) {
		try {
			return ImageRegistry.getInstance().getDescriptor(
					FamilyPlugin.getDefault().getBundle(),
