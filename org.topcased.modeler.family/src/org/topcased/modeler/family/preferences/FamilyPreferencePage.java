...
/**
 * A preference page to configure all preferences of the Family editor.
 *
 * @generated
 */
public class FamilyPreferencePage extends AbstractTopcasedPreferencePage {
	/**
	 * @generated
	 */
	...
	private void createHeader(Composite parent) {
		new Label(parent, SWT.WRAP).setText("Family editor preference page");
	}
