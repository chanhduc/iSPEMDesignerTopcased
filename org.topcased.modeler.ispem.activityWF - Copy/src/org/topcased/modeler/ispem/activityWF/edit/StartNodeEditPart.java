...
import org.topcased.modeler.ispem.activityWF.commands.StartNodeRestoreConnectionCommand;
import org.topcased.modeler.ispem.activityWF.figures.StartNodeFigure;
...
public class StartNodeEditPart extends NodeEditPart {
	...
	protected Color getPreferenceDefaultBackgroundColor() {
		String backgroundColor = getPreferenceStore()
				.getString(
						ActivityWFDiagramPreferenceConstants.STARTNODE_DEFAULT_BACKGROUND_COLOR);
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String foregroundColor = getPreferenceStore()
				.getString(
						ActivityWFDiagramPreferenceConstants.STARTNODE_DEFAULT_FOREGROUND_COLOR);
