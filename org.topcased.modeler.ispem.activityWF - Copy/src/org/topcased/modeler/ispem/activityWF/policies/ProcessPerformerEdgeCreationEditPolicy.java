...
import org.topcased.modeler.ispem.activityWF.commands.ProcessPerformerEdgeCreationCommand;
import org.topcased.modeler.utils.SourceTargetData;
import org.topcased.modeler.utils.Utils;
import org.topcased.spem.ProcessPerformer;

/**
 * ProcessPerformer edge creation
 *
 * @generated
 */
public class ProcessPerformerEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new ProcessPerformerEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		return Utils.getElement(edge) instanceof ProcessPerformer;
	}
	...
	protected boolean checkSource(GraphElement source) {
		...
		if (object instanceof org.topcased.spem.RoleUse) {
			return true;
		}
		return false;
	}
	...
	protected boolean checkTargetForSource(GraphElement source,
		...
		if (sourceObject instanceof org.topcased.spem.RoleUse
				&& targetObject instanceof org.topcased.spem.TaskUse) {
	...
	protected boolean checkCommand(Command command) {
		return command instanceof ProcessPerformerEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source,
		...
		if (sourceObject instanceof org.topcased.spem.RoleUse
			...
			return new SourceTargetData(false, false, SourceTargetData.DIAGRAM,
					...
					"linkedRoleUse", "linkedTaskUse", null, null, null, null);
		}
		return null;
	}
