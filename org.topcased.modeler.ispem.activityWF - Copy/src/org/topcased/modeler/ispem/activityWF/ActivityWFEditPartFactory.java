...
import org.topcased.modeler.ispem.activityWF.edit.ProcessParameterEditPart;
...
public class ActivityWFEditPartFactory extends ModelerEditPartFactory {
		...
		public Object caseNode(org.topcased.spem.activity.Node object) {
			try {
				if (EvaluatorsManager
						...
						.evaluate(
								object,
								"!self.oclIsTypeOf(StartNode) && !self.oclIsTypeOf(EndNode) && !self.oclIsTypeOf(ForkNode) && !self.oclIsTypeOf(JoinNode) && !self.oclIsTypeOf(DecisonNode)",
								"ocl")) {
	...
	private class EdgeSpemSwitch extends SpemSwitch {
		...
		public Object caseProcessParameter(
			...
			return new ProcessParameterEditPart(edge);
		}
