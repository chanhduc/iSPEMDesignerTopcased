 ...
 * @generated
 */
public class ProcessPerformerPreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return ActivityWFDiagramPreferenceConstants.PROCESSPERFORMER_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ActivityWFDiagramPreferenceConstants.PROCESSPERFORMER_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ActivityWFDiagramPreferenceConstants.PROCESSPERFORMER_EDGE_DEFAULT_ROUTER;
	}
