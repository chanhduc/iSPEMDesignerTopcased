...
public class EndNodePreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return ActivityWFDiagramPreferenceConstants.ENDNODE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ActivityWFDiagramPreferenceConstants.ENDNODE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ActivityWFDiagramPreferenceConstants.ENDNODE_DEFAULT_FOREGROUND_COLOR;
	}
