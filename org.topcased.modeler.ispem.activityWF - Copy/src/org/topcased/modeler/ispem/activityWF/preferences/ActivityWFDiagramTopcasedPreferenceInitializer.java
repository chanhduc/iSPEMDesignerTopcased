...
public class ActivityWFDiagramTopcasedPreferenceInitializer implements
	...
	public HashMap<String, String> getDefaultPreference() {
		...
		// Initialize the default value of the PROCESSPARAMETER_EDGE_DEFAULT_FONT property
		defaultActivityWFPreference
				.put(ActivityWFDiagramPreferenceConstants.PROCESSPARAMETER_EDGE_DEFAULT_FONT,
						StringConverter.asFontData("Segoe UI-regular-9")
								.toString());

		// Initialize the default value of the PROCESSPARAMETER_EDGE_DEFAULT_FOREGROUND_COLOR property
		defaultActivityWFPreference
				.put(ActivityWFDiagramPreferenceConstants.PROCESSPARAMETER_EDGE_DEFAULT_FOREGROUND_COLOR,
						"0,0,0");

		// Initialize the default value of the PROCESSPARAMETER_EDGE_DEFAULT_ROUTER property
		defaultActivityWFPreference
				.put(ActivityWFDiagramPreferenceConstants.PROCESSPARAMETER_EDGE_DEFAULT_ROUTER,
						"ObliqueRouter");

		// Initialize the default value of the PROCESSPARAMETER_DIRECTION_EDGE_OBJECT_DEFAULT_VISIBILITY property
		defaultActivityWFPreference
				.put(ActivityWFDiagramPreferenceConstants.PROCESSPARAMETER_DIRECTION_EDGE_OBJECT_DEFAULT_VISIBILITY,
						"true");
