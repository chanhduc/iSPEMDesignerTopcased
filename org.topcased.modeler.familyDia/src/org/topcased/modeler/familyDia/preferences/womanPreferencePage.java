 ...
 * @generated
 */
public class womanPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return MyfamilyDiagramPreferenceConstants.WOMAN_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return MyfamilyDiagramPreferenceConstants.WOMAN_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return MyfamilyDiagramPreferenceConstants.WOMAN_DEFAULT_FOREGROUND_COLOR;
	}
