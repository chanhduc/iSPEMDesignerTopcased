 ...
 * @generated
 */
public class MarryWithPreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return MyfamilyDiagramPreferenceConstants.MARRYWITH_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return MyfamilyDiagramPreferenceConstants.MARRYWITH_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return MyfamilyDiagramPreferenceConstants.MARRYWITH_EDGE_DEFAULT_ROUTER;
	}
