 ...
 ******************************************************************************/
package org.topcased.modeler.familyDia.policies;
...
import org.topcased.modeler.familyDia.commands.MarryWithEdgeCreationCommand;
import org.topcased.modeler.utils.SourceTargetData;
import org.topcased.modeler.utils.Utils;

/**
 * MarryWith edge creation
 *
 * @generated
 */
public class MarryWithEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new MarryWithEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		if (edge.getSemanticModel() instanceof SimpleSemanticModelElement) {
			return MyfamilySimpleObjectConstants.SIMPLE_OBJECT_MARRYWITH
	...
	protected boolean checkSource(GraphElement source) {
		...
		if (object instanceof org.topcased.family.person) {
			return true;
		}
		return false;
	}
	...
	protected boolean checkTargetForSource(GraphElement source,
		...
		if (sourceObject instanceof org.topcased.family.person
				&& targetObject instanceof org.topcased.family.person) {
	...
	protected boolean checkCommand(Command command) {
		return command instanceof MarryWithEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source,
		...
		if (sourceObject instanceof org.topcased.family.person
			...
			return new SourceTargetData(false, false, SourceTargetData.NONE,
					null, null, null, null, null, "marryWith", null, null);
		}
		return null;
	}
