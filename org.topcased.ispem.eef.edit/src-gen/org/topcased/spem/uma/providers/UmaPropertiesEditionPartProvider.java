...
import org.topcased.spem.uma.parts.forms.ArtifactPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.CapabilityPatternPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.CapabilityPatternPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.CategoryPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.ChecklistPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.ConceptPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.ConfigurationPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.CustomCategoryPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.DeliverablePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.DeliveryProcessPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.DeliveryProcessPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.DisciplineGroupingPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.DisciplinePackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.DisciplinePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.DomainPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.DomainPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.EstimatingConsiderationPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.ExamplePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.GuidancePackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.GuidelinePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.IterationPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.OutcomePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.PhasePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.PracticePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.ProcessComponentPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.ProcessPlanningTemplatePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.ProcessPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.QualificationPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.ReportPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.ReusableAssetPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.RoadmapPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.RoleDefinitionPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.RoleSetPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.RoleSetPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.RootPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.SupportingMaterialPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.TaskDefinitionPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.TemplatePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.TermDefinitionPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.ToolDefinitionPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.ToolMentorPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.WhitepaperPropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.WorkProductDefinitionPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.WorkProductKindPackagePropertiesEditionPartForm;
import org.topcased.spem.uma.parts.forms.WorkProductKindPropertiesEditionPartForm;

import org.topcased.spem.uma.parts.impl.ArtifactPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.CapabilityPatternPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.CapabilityPatternPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.CategoryPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.ChecklistPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.ConceptPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.ConfigurationPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.CustomCategoryPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.DeliverablePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.DeliveryProcessPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.DeliveryProcessPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.DisciplineGroupingPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.DisciplinePackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.DisciplinePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.DomainPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.DomainPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.EstimatingConsiderationPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.ExamplePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.GuidancePackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.GuidelinePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.IterationPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.OutcomePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.PhasePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.PracticePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.ProcessComponentPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.ProcessPlanningTemplatePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.ProcessPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.QualificationPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.ReportPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.ReusableAssetPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.RoadmapPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.RoleDefinitionPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.RoleSetPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.RoleSetPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.RootPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.SupportingMaterialPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.TaskDefinitionPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.TemplatePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.TermDefinitionPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.ToolDefinitionPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.ToolMentorPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.WhitepaperPropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.WorkProductDefinitionPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.WorkProductKindPackagePropertiesEditionPartImpl;
import org.topcased.spem.uma.parts.impl.WorkProductKindPropertiesEditionPartImpl;
...
public class UmaPropertiesEditionPartProvider implements IPropertiesEditionPartProvider {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(Object key, int kind, IPropertiesEditionComponent component) {
		...
		if (key == UmaViewsRepository.WorkProductKind.class) {
			if (kind == UmaViewsRepository.SWT_KIND)
				return new WorkProductKindPropertiesEditionPartImpl(component);
			if (kind == UmaViewsRepository.FORM_KIND)
				return new WorkProductKindPropertiesEditionPartForm(component);
		}
		return null;
	}
