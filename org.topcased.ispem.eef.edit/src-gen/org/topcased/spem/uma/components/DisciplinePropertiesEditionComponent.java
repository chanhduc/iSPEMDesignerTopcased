...
import org.topcased.spem.uma.parts.DisciplinePropertiesEditionPart;
...
public class DisciplinePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmaViewsRepository.Discipline.Properties.presentationName))
				basePart.setPresentationName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, discipline.getPresentationName()));
			
			if (isAccessible(UmaViewsRepository.Discipline.Properties.briefDescription))
				basePart.setBriefDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, discipline.getBriefDescription()));
			
			if (isAccessible(UmaViewsRepository.Discipline.Properties.mainDescription))
				basePart.setMainDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, discipline.getMainDescription()));
			
			if (isAccessible(UmaViewsRepository.Discipline.Properties.purpose))
				basePart.setPurpose(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, discipline.getPurpose()));
			...
			if (isAccessible(UmaViewsRepository.Discipline.Properties.copyright))
				basePart.setCopyright(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, discipline.getCopyright()));
			
			if (isAccessible(UmaViewsRepository.Discipline.Properties.author))
				basePart.setAuthor(discipline.getAuthor());
			
			if (isAccessible(UmaViewsRepository.Discipline.Properties.changeDate))
				basePart.setChangeDate(EEFConverterUtil.convertToString(EcorePackage.Literals.EDATE, discipline.getChangeDate()));
			
			if (isAccessible(UmaViewsRepository.Discipline.Properties.changeDescription))
				basePart.setChangeDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, discipline.getChangeDescription()));
			
			if (isAccessible(UmaViewsRepository.Discipline.Properties.version))
				basePart.setVersion(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, discipline.getVersion()));
			
			if (isAccessible(UmaViewsRepository.Discipline.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, discipline.getName()));
			
			if (isAccessible(UmaViewsRepository.Discipline.Properties.variabilityType)) {
				basePart.initVariabilityType(EEFUtils.choiceOfValues(discipline, SpemPackage.eINSTANCE.getVariabilityElement_VariabilityType()), discipline.getVariabilityType());
			}
			...
			if (isAccessible(UmaViewsRepository.Discipline.Properties.relatedTask)) {
				basePart.addFilterToRelatedTask(new EObjectFilter(SpemPackage.Literals.TASK_DEFINITION));
				// Start of user code for additional businessfilters for relatedTask
				// End of user code
			}
			if (isAccessible(UmaViewsRepository.Discipline.Properties.relatedWorflow)) {
				basePart.addFilterToRelatedWorflow(new EObjectFilter(UmaPackage.Literals.PROCESS));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmaViewsRepository.Discipline.Properties.presentationName == event.getAffectedEditor()) {
			discipline.setPresentationName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Discipline.Properties.briefDescription == event.getAffectedEditor()) {
			discipline.setBriefDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Discipline.Properties.mainDescription == event.getAffectedEditor()) {
			discipline.setMainDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Discipline.Properties.purpose == event.getAffectedEditor()) {
			discipline.setPurpose((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		...
		if (UmaViewsRepository.Discipline.Properties.copyright == event.getAffectedEditor()) {
			discipline.setCopyright((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Discipline.Properties.author == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				discipline.getAuthor().clear();
				discipline.getAuthor().addAll(((EList) event.getNewValue()));
			}
		}
		if (UmaViewsRepository.Discipline.Properties.changeDate == event.getAffectedEditor()) {
			discipline.setChangeDate((java.util.Date)EEFConverterUtil.createFromString(EcorePackage.Literals.EDATE, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Discipline.Properties.changeDescription == event.getAffectedEditor()) {
			discipline.setChangeDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Discipline.Properties.version == event.getAffectedEditor()) {
			discipline.setVersion((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Discipline.Properties.name == event.getAffectedEditor()) {
			discipline.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_PresentationName().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.Discipline.Properties.presentationName)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_BriefDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.Discipline.Properties.briefDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_MainDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.Discipline.Properties.mainDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Purpose().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.Discipline.Properties.purpose)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Copyright().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.Discipline.Properties.copyright)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Author().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.Discipline.Properties.author)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDate().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.Discipline.Properties.changeDate)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.Discipline.Properties.changeDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Version().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.Discipline.Properties.version)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getMethodContentPackageableElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.Discipline.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getVariabilityElement_VariabilityType().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmaViewsRepository.Discipline.Properties.variabilityType))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			UmaPackage.eINSTANCE.getDiscipline_RelatedTask(),
			UmaPackage.eINSTANCE.getDiscipline_RelatedWorflow()		);
