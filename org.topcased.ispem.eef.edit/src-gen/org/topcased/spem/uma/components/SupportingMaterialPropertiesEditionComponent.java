...
public class SupportingMaterialPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmaViewsRepository.SupportingMaterial.Properties.presentationName))
				basePart.setPresentationName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, supportingMaterial.getPresentationName()));
			
			if (isAccessible(UmaViewsRepository.SupportingMaterial.Properties.briefDescription))
				basePart.setBriefDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, supportingMaterial.getBriefDescription()));
			
			if (isAccessible(UmaViewsRepository.SupportingMaterial.Properties.mainDescription))
				basePart.setMainDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, supportingMaterial.getMainDescription()));
			
			if (isAccessible(UmaViewsRepository.SupportingMaterial.Properties.purpose))
				basePart.setPurpose(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, supportingMaterial.getPurpose()));
			...
			if (isAccessible(UmaViewsRepository.SupportingMaterial.Properties.copyright))
				basePart.setCopyright(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, supportingMaterial.getCopyright()));
			
			if (isAccessible(UmaViewsRepository.SupportingMaterial.Properties.author))
				basePart.setAuthor(supportingMaterial.getAuthor());
			
			if (isAccessible(UmaViewsRepository.SupportingMaterial.Properties.changeDate))
				basePart.setChangeDate(EEFConverterUtil.convertToString(EcorePackage.Literals.EDATE, supportingMaterial.getChangeDate()));
			
			if (isAccessible(UmaViewsRepository.SupportingMaterial.Properties.changeDescription))
				basePart.setChangeDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, supportingMaterial.getChangeDescription()));
			
			if (isAccessible(UmaViewsRepository.SupportingMaterial.Properties.version))
				basePart.setVersion(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, supportingMaterial.getVersion()));
			
			if (isAccessible(UmaViewsRepository.SupportingMaterial.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, supportingMaterial.getName()));
			
			if (isAccessible(UmaViewsRepository.SupportingMaterial.Properties.variabilityType)) {
				basePart.initVariabilityType(EEFUtils.choiceOfValues(supportingMaterial, SpemPackage.eINSTANCE.getVariabilityElement_VariabilityType()), supportingMaterial.getVariabilityType());
			}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmaViewsRepository.SupportingMaterial.Properties.presentationName == event.getAffectedEditor()) {
			supportingMaterial.setPresentationName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.SupportingMaterial.Properties.briefDescription == event.getAffectedEditor()) {
			supportingMaterial.setBriefDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.SupportingMaterial.Properties.mainDescription == event.getAffectedEditor()) {
			supportingMaterial.setMainDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.SupportingMaterial.Properties.purpose == event.getAffectedEditor()) {
			supportingMaterial.setPurpose((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		...
		if (UmaViewsRepository.SupportingMaterial.Properties.copyright == event.getAffectedEditor()) {
			supportingMaterial.setCopyright((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.SupportingMaterial.Properties.author == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				supportingMaterial.getAuthor().clear();
				supportingMaterial.getAuthor().addAll(((EList) event.getNewValue()));
			}
		}
		if (UmaViewsRepository.SupportingMaterial.Properties.changeDate == event.getAffectedEditor()) {
			supportingMaterial.setChangeDate((java.util.Date)EEFConverterUtil.createFromString(EcorePackage.Literals.EDATE, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.SupportingMaterial.Properties.changeDescription == event.getAffectedEditor()) {
			supportingMaterial.setChangeDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.SupportingMaterial.Properties.version == event.getAffectedEditor()) {
			supportingMaterial.setVersion((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (UmaViewsRepository.SupportingMaterial.Properties.name == event.getAffectedEditor()) {
			supportingMaterial.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_PresentationName().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.SupportingMaterial.Properties.presentationName)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_BriefDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.SupportingMaterial.Properties.briefDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_MainDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.SupportingMaterial.Properties.mainDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Purpose().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.SupportingMaterial.Properties.purpose)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Copyright().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.SupportingMaterial.Properties.copyright)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Author().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.SupportingMaterial.Properties.author)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDate().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.SupportingMaterial.Properties.changeDate)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.SupportingMaterial.Properties.changeDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Version().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.SupportingMaterial.Properties.version)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getMethodContentPackageableElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmaViewsRepository.SupportingMaterial.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getVariabilityElement_VariabilityType().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmaViewsRepository.SupportingMaterial.Properties.variabilityType))
