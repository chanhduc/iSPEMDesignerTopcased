...
import org.topcased.spem.parts.WorkProductPortPropertiesEditionPart;
...
public class WorkProductPortPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(SpemViewsRepository.WorkProductPort.Properties.presentationName))
				basePart.setPresentationName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, workProductPort.getPresentationName()));
			
			if (isAccessible(SpemViewsRepository.WorkProductPort.Properties.briefDescription))
				basePart.setBriefDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, workProductPort.getBriefDescription()));
			
			if (isAccessible(SpemViewsRepository.WorkProductPort.Properties.mainDescription))
				basePart.setMainDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, workProductPort.getMainDescription()));
			
			if (isAccessible(SpemViewsRepository.WorkProductPort.Properties.purpose))
				basePart.setPurpose(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, workProductPort.getPurpose()));
			...
			if (isAccessible(SpemViewsRepository.WorkProductPort.Properties.copyright))
				basePart.setCopyright(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, workProductPort.getCopyright()));
			
			if (isAccessible(SpemViewsRepository.WorkProductPort.Properties.author))
				basePart.setAuthor(workProductPort.getAuthor());
			
			if (isAccessible(SpemViewsRepository.WorkProductPort.Properties.changeDate))
				basePart.setChangeDate(EEFConverterUtil.convertToString(EcorePackage.Literals.EDATE, workProductPort.getChangeDate()));
			
			if (isAccessible(SpemViewsRepository.WorkProductPort.Properties.changeDescription))
				basePart.setChangeDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, workProductPort.getChangeDescription()));
			
			if (isAccessible(SpemViewsRepository.WorkProductPort.Properties.version))
				basePart.setVersion(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, workProductPort.getVersion()));
			
			if (isAccessible(SpemViewsRepository.WorkProductPort.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, workProductPort.getName()));
			...
			if (isAccessible(SpemViewsRepository.WorkProductPort.Properties.portKind)) {
				basePart.initPortKind(EEFUtils.choiceOfValues(workProductPort, SpemPackage.eINSTANCE.getWorkProductPort_PortKind()), workProductPort.getPortKind());
			}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (SpemViewsRepository.WorkProductPort.Properties.presentationName == event.getAffectedEditor()) {
			workProductPort.setPresentationName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPort.Properties.briefDescription == event.getAffectedEditor()) {
			workProductPort.setBriefDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPort.Properties.mainDescription == event.getAffectedEditor()) {
			workProductPort.setMainDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPort.Properties.purpose == event.getAffectedEditor()) {
			workProductPort.setPurpose((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		...
		if (SpemViewsRepository.WorkProductPort.Properties.copyright == event.getAffectedEditor()) {
			workProductPort.setCopyright((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPort.Properties.author == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				workProductPort.getAuthor().clear();
				workProductPort.getAuthor().addAll(((EList) event.getNewValue()));
			}
		}
		if (SpemViewsRepository.WorkProductPort.Properties.changeDate == event.getAffectedEditor()) {
			workProductPort.setChangeDate((java.util.Date)EEFConverterUtil.createFromString(EcorePackage.Literals.EDATE, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPort.Properties.changeDescription == event.getAffectedEditor()) {
			workProductPort.setChangeDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPort.Properties.version == event.getAffectedEditor()) {
			workProductPort.setVersion((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPort.Properties.name == event.getAffectedEditor()) {
			workProductPort.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_PresentationName().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPort.Properties.presentationName)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_BriefDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPort.Properties.briefDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_MainDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPort.Properties.mainDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Purpose().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPort.Properties.purpose)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Copyright().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPort.Properties.copyright)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Author().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPort.Properties.author)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDate().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPort.Properties.changeDate)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPort.Properties.changeDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Version().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPort.Properties.version)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getProcessPackageableElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPort.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getWorkProductPort_IsOptional().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPort.Properties.isOptional))
				basePart.setIsOptional((Boolean)msg.getNewValue());
			
			if (SpemPackage.eINSTANCE.getWorkProductPort_PortKind().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(SpemViewsRepository.WorkProductPort.Properties.portKind))
				basePart.setPortKind((ParameterDirectionKind)msg.getNewValue());
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			SpemPackage.eINSTANCE.getWorkProductPort_IsOptional(),
			SpemPackage.eINSTANCE.getWorkProductPort_PortKind(),
			SpemPackage.eINSTANCE.getWorkProductPort_PortType()		);
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (SpemViewsRepository.WorkProductPort.Properties.isOptional == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(SpemPackage.eINSTANCE.getWorkProductPort_IsOptional().getEAttributeType(), (String)newValue);
					}
				...
				if (SpemViewsRepository.WorkProductPort.Properties.portKind == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(SpemPackage.eINSTANCE.getWorkProductPort_PortKind().getEAttributeType(), (String)newValue);
					}
