...
public class Default_TaskDefinitionParameterPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(SpemViewsRepository.Default_TaskDefinitionParameter.Properties.direction)) {
				basePart.initDirection(EEFUtils.choiceOfValues(default_TaskDefinitionParameter, SpemPackage.eINSTANCE.getWorkDefinitionParameter_Direction()), default_TaskDefinitionParameter.getDirection());
			}
			if (isAccessible(SpemViewsRepository.Default_TaskDefinitionParameter.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, default_TaskDefinitionParameter.getName()));
			...
			if (isAccessible(SpemViewsRepository.Default_TaskDefinitionParameter.Properties.optionality)) {
				basePart.initOptionality(EEFUtils.choiceOfValues(default_TaskDefinitionParameter, SpemPackage.eINSTANCE.getDefault_TaskDefinitionParameter_Optionality()), default_TaskDefinitionParameter.getOptionality());
			}
			// init filters
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (SpemViewsRepository.Default_TaskDefinitionParameter.Properties.name == event.getAffectedEditor()) {
			default_TaskDefinitionParameter.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (SpemPackage.eINSTANCE.getWorkDefinitionParameter_Direction().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(SpemViewsRepository.Default_TaskDefinitionParameter.Properties.direction))
				basePart.setDirection((ParameterDirectionKind)msg.getNewValue());
			
			if (SpemPackage.eINSTANCE.getDefault_TaskDefinitionParameter_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.Default_TaskDefinitionParameter.Properties.name)) {
			...
			if (SpemPackage.eINSTANCE.getDefault_TaskDefinitionParameter_Optionality().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(SpemViewsRepository.Default_TaskDefinitionParameter.Properties.optionality))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			SpemPackage.eINSTANCE.getDefault_TaskDefinitionParameter_Name(),
			SpemPackage.eINSTANCE.getDefault_TaskDefinitionParameter_ParameterType(),
			SpemPackage.eINSTANCE.getDefault_TaskDefinitionParameter_Optionality()		);
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (SpemViewsRepository.Default_TaskDefinitionParameter.Properties.name == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(SpemPackage.eINSTANCE.getDefault_TaskDefinitionParameter_Name().getEAttributeType(), (String)newValue);
					}
				...
				if (SpemViewsRepository.Default_TaskDefinitionParameter.Properties.optionality == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(SpemPackage.eINSTANCE.getDefault_TaskDefinitionParameter_Optionality().getEAttributeType(), (String)newValue);
					}
