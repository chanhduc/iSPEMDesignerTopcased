...
import org.topcased.spem.parts.PlanningDataPropertiesEditionPart;
...
public class PlanningDataPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.presentationName))
				basePart.setPresentationName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, planningData.getPresentationName()));
			
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.briefDescription))
				basePart.setBriefDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, planningData.getBriefDescription()));
			
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.mainDescription))
				basePart.setMainDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, planningData.getMainDescription()));
			
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.purpose))
				basePart.setPurpose(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, planningData.getPurpose()));
			...
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.copyright))
				basePart.setCopyright(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, planningData.getCopyright()));
			
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.author))
				basePart.setAuthor(planningData.getAuthor());
			
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.changeDate))
				basePart.setChangeDate(EEFConverterUtil.convertToString(EcorePackage.Literals.EDATE, planningData.getChangeDate()));
			
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.changeDescription))
				basePart.setChangeDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, planningData.getChangeDescription()));
			
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.version))
				basePart.setVersion(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, planningData.getVersion()));
			
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, planningData.getName()));
			
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.startDate))
				basePart.setStartDate(EEFConverterUtil.convertToString(EcorePackage.Literals.EDATE, planningData.getStartDate()));
			
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.finishDate))
				basePart.setFinishDate(EEFConverterUtil.convertToString(EcorePackage.Literals.EDATE, planningData.getFinishDate()));
			
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.rank)) {
				basePart.setRank(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, planningData.getRank()));
			}
			
			if (isAccessible(SpemViewsRepository.PlanningData.Properties.duration))
				basePart.setDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, planningData.getDuration()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (SpemViewsRepository.PlanningData.Properties.presentationName == event.getAffectedEditor()) {
			planningData.setPresentationName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.PlanningData.Properties.briefDescription == event.getAffectedEditor()) {
			planningData.setBriefDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.PlanningData.Properties.mainDescription == event.getAffectedEditor()) {
			planningData.setMainDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.PlanningData.Properties.purpose == event.getAffectedEditor()) {
			planningData.setPurpose((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		...
		if (SpemViewsRepository.PlanningData.Properties.copyright == event.getAffectedEditor()) {
			planningData.setCopyright((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.PlanningData.Properties.author == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				planningData.getAuthor().clear();
				planningData.getAuthor().addAll(((EList) event.getNewValue()));
			}
		}
		if (SpemViewsRepository.PlanningData.Properties.changeDate == event.getAffectedEditor()) {
			planningData.setChangeDate((java.util.Date)EEFConverterUtil.createFromString(EcorePackage.Literals.EDATE, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.PlanningData.Properties.changeDescription == event.getAffectedEditor()) {
			planningData.setChangeDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.PlanningData.Properties.version == event.getAffectedEditor()) {
			planningData.setVersion((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.PlanningData.Properties.name == event.getAffectedEditor()) {
			planningData.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.PlanningData.Properties.startDate == event.getAffectedEditor()) {
			planningData.setStartDate((java.util.Date)EEFConverterUtil.createFromString(EcorePackage.Literals.EDATE, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.PlanningData.Properties.finishDate == event.getAffectedEditor()) {
			planningData.setFinishDate((java.util.Date)EEFConverterUtil.createFromString(EcorePackage.Literals.EDATE, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.PlanningData.Properties.rank == event.getAffectedEditor()) {
			planningData.setRank((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (SpemViewsRepository.PlanningData.Properties.duration == event.getAffectedEditor()) {
			planningData.setDuration((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_PresentationName().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.presentationName)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_BriefDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.briefDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_MainDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.mainDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Purpose().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.purpose)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Copyright().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.copyright)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Author().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.author)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDate().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.changeDate)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.changeDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Version().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.version)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getProcessPackageableElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getPlanningData_StartDate().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.startDate)) {
				if (msg.getNewValue() != null) {
					basePart.setStartDate(EcoreUtil.convertToString(EcorePackage.Literals.EDATE, msg.getNewValue()));
				} else {
					basePart.setStartDate("");
				}
			}
			if (SpemPackage.eINSTANCE.getPlanningData_FinishDate().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.finishDate)) {
				if (msg.getNewValue() != null) {
					basePart.setFinishDate(EcoreUtil.convertToString(EcorePackage.Literals.EDATE, msg.getNewValue()));
				} else {
					basePart.setFinishDate("");
				}
			}
			if (SpemPackage.eINSTANCE.getPlanningData_Rank().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.rank)) {
				if (msg.getNewValue() != null) {
					basePart.setRank(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					basePart.setRank("");
				}
			}
			if (SpemPackage.eINSTANCE.getPlanningData_Duration().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.PlanningData.Properties.duration)) {
				if (msg.getNewValue() != null) {
					basePart.setDuration(EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
				} else {
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			SpemPackage.eINSTANCE.getPlanningData_StartDate(),
			SpemPackage.eINSTANCE.getPlanningData_FinishDate(),
			SpemPackage.eINSTANCE.getPlanningData_Rank(),
			SpemPackage.eINSTANCE.getPlanningData_Duration()		);
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (SpemViewsRepository.PlanningData.Properties.startDate == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(SpemPackage.eINSTANCE.getPlanningData_StartDate().getEAttributeType(), (String)newValue);
					}
				...
				if (SpemViewsRepository.PlanningData.Properties.finishDate == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(SpemPackage.eINSTANCE.getPlanningData_FinishDate().getEAttributeType(), (String)newValue);
					}
				...
				if (SpemViewsRepository.PlanningData.Properties.rank == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(SpemPackage.eINSTANCE.getPlanningData_Rank().getEAttributeType(), (String)newValue);
					}
				...
				if (SpemViewsRepository.PlanningData.Properties.duration == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(SpemPackage.eINSTANCE.getPlanningData_Duration().getEAttributeType(), (String)newValue);
					}
