...
import org.topcased.spem.parts.ProcessResponsibilityAssignmentPropertiesEditionPart;
...
public class ProcessResponsibilityAssignmentPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.presentationName))
				basePart.setPresentationName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, processResponsibilityAssignment.getPresentationName()));
			
			if (isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.briefDescription))
				basePart.setBriefDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, processResponsibilityAssignment.getBriefDescription()));
			
			if (isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.mainDescription))
				basePart.setMainDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, processResponsibilityAssignment.getMainDescription()));
			
			if (isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.purpose))
				basePart.setPurpose(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, processResponsibilityAssignment.getPurpose()));
			...
			if (isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.copyright))
				basePart.setCopyright(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, processResponsibilityAssignment.getCopyright()));
			
			if (isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.author))
				basePart.setAuthor(processResponsibilityAssignment.getAuthor());
			
			if (isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.changeDate))
				basePart.setChangeDate(EEFConverterUtil.convertToString(EcorePackage.Literals.EDATE, processResponsibilityAssignment.getChangeDate()));
			
			if (isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.changeDescription))
				basePart.setChangeDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, processResponsibilityAssignment.getChangeDescription()));
			
			if (isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.version))
				basePart.setVersion(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, processResponsibilityAssignment.getVersion()));
			
			if (isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, processResponsibilityAssignment.getName()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (SpemViewsRepository.ProcessResponsibilityAssignment.Properties.presentationName == event.getAffectedEditor()) {
			processResponsibilityAssignment.setPresentationName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.ProcessResponsibilityAssignment.Properties.briefDescription == event.getAffectedEditor()) {
			processResponsibilityAssignment.setBriefDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.ProcessResponsibilityAssignment.Properties.mainDescription == event.getAffectedEditor()) {
			processResponsibilityAssignment.setMainDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.ProcessResponsibilityAssignment.Properties.purpose == event.getAffectedEditor()) {
			processResponsibilityAssignment.setPurpose((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		...
		if (SpemViewsRepository.ProcessResponsibilityAssignment.Properties.copyright == event.getAffectedEditor()) {
			processResponsibilityAssignment.setCopyright((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.ProcessResponsibilityAssignment.Properties.author == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				...
				processResponsibilityAssignment.getAuthor().addAll(((EList) event.getNewValue()));
			}
		}
		if (SpemViewsRepository.ProcessResponsibilityAssignment.Properties.changeDate == event.getAffectedEditor()) {
			processResponsibilityAssignment.setChangeDate((java.util.Date)EEFConverterUtil.createFromString(EcorePackage.Literals.EDATE, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.ProcessResponsibilityAssignment.Properties.changeDescription == event.getAffectedEditor()) {
			processResponsibilityAssignment.setChangeDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.ProcessResponsibilityAssignment.Properties.version == event.getAffectedEditor()) {
			processResponsibilityAssignment.setVersion((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.ProcessResponsibilityAssignment.Properties.name == event.getAffectedEditor()) {
			processResponsibilityAssignment.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_PresentationName().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.presentationName)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_BriefDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.briefDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_MainDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.mainDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Purpose().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.purpose)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Copyright().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.copyright)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Author().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.author)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDate().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.changeDate)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.changeDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Version().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.version)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getProcessPackageableElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getBreakdownElement_HasMultipleOccurrences().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.hasMultipleOccurrences))
				basePart.setHasMultipleOccurrences((Boolean)msg.getNewValue());
			
			if (SpemPackage.eINSTANCE.getBreakdownElement_IsOptional().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.isOptional))
				basePart.setIsOptional((Boolean)msg.getNewValue());
			
			if (SpemPackage.eINSTANCE.getBreakdownElement_IsPlanned().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.ProcessResponsibilityAssignment.Properties.isPlanned))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			SpemPackage.eINSTANCE.getProcessResponsibilityAssignment_LinkedRoleUse(),
			SpemPackage.eINSTANCE.getProcessResponsibilityAssignment_LinkedWorkProductUse()		);
