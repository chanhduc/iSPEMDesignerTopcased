...
public class TaskUsePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.presentationName))
				basePart.setPresentationName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, taskUse.getPresentationName()));
			
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.briefDescription))
				basePart.setBriefDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, taskUse.getBriefDescription()));
			
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.mainDescription))
				basePart.setMainDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, taskUse.getMainDescription()));
			
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.purpose))
				basePart.setPurpose(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, taskUse.getPurpose()));
			...
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.copyright))
				basePart.setCopyright(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, taskUse.getCopyright()));
			
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.author))
				basePart.setAuthor(taskUse.getAuthor());
			
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.changeDate))
				basePart.setChangeDate(EEFConverterUtil.convertToString(EcorePackage.Literals.EDATE, taskUse.getChangeDate()));
			
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.changeDescription))
				basePart.setChangeDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, taskUse.getChangeDescription()));
			
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.version))
				basePart.setVersion(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, taskUse.getVersion()));
			
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, taskUse.getName()));
			...
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.preCondition))
				basePart.setPreCondition(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, taskUse.getPreCondition()));
			
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.postCondition))
				basePart.setPostCondition(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, taskUse.getPostCondition()));
			...
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.usedQualification)) {
				basePart.addFilterToUsedQualification(new EObjectFilter(SpemPackage.Literals.QUALIFICATION));
				// Start of user code for additional businessfilters for usedQualification
				// End of user code
			}
			if (isAccessible(SpemViewsRepository.TaskUse.Properties.selectedStep)) {
				basePart.addFilterToSelectedStep(new EObjectFilter(SpemPackage.Literals.STEP));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (SpemViewsRepository.TaskUse.Properties.presentationName == event.getAffectedEditor()) {
			taskUse.setPresentationName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.TaskUse.Properties.briefDescription == event.getAffectedEditor()) {
			taskUse.setBriefDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.TaskUse.Properties.mainDescription == event.getAffectedEditor()) {
			taskUse.setMainDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.TaskUse.Properties.purpose == event.getAffectedEditor()) {
			taskUse.setPurpose((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		...
		if (SpemViewsRepository.TaskUse.Properties.copyright == event.getAffectedEditor()) {
			taskUse.setCopyright((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.TaskUse.Properties.author == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				taskUse.getAuthor().clear();
				taskUse.getAuthor().addAll(((EList) event.getNewValue()));
			}
		}
		if (SpemViewsRepository.TaskUse.Properties.changeDate == event.getAffectedEditor()) {
			taskUse.setChangeDate((java.util.Date)EEFConverterUtil.createFromString(EcorePackage.Literals.EDATE, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.TaskUse.Properties.changeDescription == event.getAffectedEditor()) {
			taskUse.setChangeDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.TaskUse.Properties.version == event.getAffectedEditor()) {
			taskUse.setVersion((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.TaskUse.Properties.name == event.getAffectedEditor()) {
			taskUse.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		...
		if (SpemViewsRepository.TaskUse.Properties.preCondition == event.getAffectedEditor()) {
			taskUse.setPreCondition((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SpemViewsRepository.TaskUse.Properties.postCondition == event.getAffectedEditor()) {
			taskUse.setPostCondition((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_PresentationName().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.presentationName)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_BriefDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.briefDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_MainDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.mainDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Purpose().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.purpose)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Copyright().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.copyright)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Author().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.author)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDate().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.changeDate)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDescription().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.changeDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Version().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.version)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getProcessPackageableElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getBreakdownElement_HasMultipleOccurrences().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.hasMultipleOccurrences))
				basePart.setHasMultipleOccurrences((Boolean)msg.getNewValue());
			
			if (SpemPackage.eINSTANCE.getBreakdownElement_IsOptional().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.isOptional))
				basePart.setIsOptional((Boolean)msg.getNewValue());
			
			if (SpemPackage.eINSTANCE.getBreakdownElement_IsPlanned().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.isPlanned))
				basePart.setIsPlanned((Boolean)msg.getNewValue());
			
			if (SpemPackage.eINSTANCE.getMethodContentUse_IsSynchronizedWithSource().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.isSynchronizedWithSource))
				basePart.setIsSynchronizedWithSource((Boolean)msg.getNewValue());
			
			if (SpemPackage.eINSTANCE.getWorkBreakdownElement_IsRepeatable().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.isRepeatable))
				basePart.setIsRepeatable((Boolean)msg.getNewValue());
			
			if (SpemPackage.eINSTANCE.getWorkBreakdownElement_IsOngoing().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.isOngoing))
				basePart.setIsOngoing((Boolean)msg.getNewValue());
			
			if (SpemPackage.eINSTANCE.getWorkBreakdownElement_IsEventDriven().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.isEventDriven))
			...
			if (SpemPackage.eINSTANCE.getTaskUse_PreCondition().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.preCondition)) {
				if (msg.getNewValue() != null) {
					basePart.setPreCondition(EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
				} else {
					basePart.setPreCondition("");
				}
			}
			if (SpemPackage.eINSTANCE.getTaskUse_PostCondition().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SpemViewsRepository.TaskUse.Properties.postCondition)) {
				if (msg.getNewValue() != null) {
					basePart.setPostCondition(EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
				} else {
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			SpemPackage.eINSTANCE.getTaskUse_Task(),
			SpemPackage.eINSTANCE.getTaskUse_UsedQualification(),
			SpemPackage.eINSTANCE.getTaskUse_SelectedStep(),
			SpemPackage.eINSTANCE.getTaskUse_PreCondition(),
			SpemPackage.eINSTANCE.getTaskUse_PostCondition()		);
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (SpemViewsRepository.TaskUse.Properties.preCondition == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(SpemPackage.eINSTANCE.getTaskUse_PreCondition().getEAttributeType(), (String)newValue);
					}
				...
				if (SpemViewsRepository.TaskUse.Properties.postCondition == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(SpemPackage.eINSTANCE.getTaskUse_PostCondition().getEAttributeType(), (String)newValue);
					}
