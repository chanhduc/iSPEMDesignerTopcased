...
import org.topcased.ispem.components.ActivityPropertiesEditionComponent;
...
public class ActivityPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Activity) 
					&& (IspemPackage.Literals.ACTIVITY == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && IspemPackage.Literals.ACTIVITY == eObj.eClass();
		}
